 ...
 */
#define Z_MIN_PROBE_PIN PB9 // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, 0, -1.2 }
 ...
 * A switch indicating proper d   eployment, or an optical
...
//
// EasyThreeD Buttons for Nano, K7
//
