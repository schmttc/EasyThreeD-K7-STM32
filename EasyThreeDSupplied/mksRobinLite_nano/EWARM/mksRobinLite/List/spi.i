...
void MX_SPI2_Init(void)
{
  ...
  hspi2.Instance = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800));
  hspi2.Init.Mode = ((0x1U << (2U)) | (0x1U << (8U)));
  hspi2.Init.Direction = ((uint32_t)0x00000000);
  hspi2.Init.DataSize = ((uint32_t)0x00000000);
  hspi2.Init.CLKPolarity = ((uint32_t)0x00000000);	
  hspi2.Init.CLKPhase = ((uint32_t)0x00000000);		



  
  hspi2.Init.NSS = (0x1U << (9U));
  
  hspi2.Init.BaudRatePrescaler = ((uint32_t)(0x2U << (3U)) | (0x1U << (3U)));	
  ...
  hspi2.Init.FirstBit = ((uint32_t)0x00000000);
  hspi2.Init.TIMode = ((uint32_t)0x00000000);
  hspi2.Init.CRCCalculation = ((uint32_t)0x00000000);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x2000)|((uint16_t)0x8000);
    ...
    hdma_spi2_rx.Instance = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044));
    hdma_spi2_rx.Init.Direction = ((uint32_t)0x00000000);
    hdma_spi2_rx.Init.PeriphInc = ((uint32_t)0x00000000);
    hdma_spi2_rx.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    hdma_spi2_rx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
    hdma_spi2_rx.Init.MemDataAlignment = ((uint32_t)0x00000000);
    hdma_spi2_rx.Init.Mode = ((uint32_t)0x00000000);
    hdma_spi2_rx.Init.Priority = ((uint32_t)0x00000000);
    if (HAL_DMA_Init(&hdma_spi2_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (spiHandle)->hdmarx = &(hdma_spi2_rx); (hdma_spi2_rx). Parent = (spiHandle); } while(0);

    hdma_spi2_tx.Instance = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058));
    hdma_spi2_tx.Init.Direction = ((uint32_t)(0x1U << (4U)));
    hdma_spi2_tx.Init.PeriphInc = ((uint32_t)0x00000000);
    hdma_spi2_tx.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    hdma_spi2_tx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
    hdma_spi2_tx.Init.MemDataAlignment = ((uint32_t)0x00000000);
    hdma_spi2_tx.Init.Mode = ((uint32_t)0x00000000);
    hdma_spi2_tx.Init.Priority = ((uint32_t)0x00000000);
    if (HAL_DMA_Init(&hdma_spi2_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (spiHandle)->hdmatx = &(hdma_spi2_tx); (hdma_spi2_tx). Parent = (spiHandle); } while(0);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR &= ~((0x1U << (14U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000));
...
{
  ((void)0);
	((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->CR1&=0XFFC7;
	((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->CR1|=SPI_BaudRatePrescaler;	
...
{		 			 
  ...
  while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0x0002)) == RESET){}
	...
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), TxData); 
