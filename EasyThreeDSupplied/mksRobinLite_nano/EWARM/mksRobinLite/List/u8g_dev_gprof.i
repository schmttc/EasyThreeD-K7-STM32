...
uint8_t u8g_pb_dev_gprof_buf[128];
u8g_pb_t u8g_pb_dev_gprof = { {8, 64, 0, 0, 0},  128, u8g_pb_dev_gprof_buf };

u8g_dev_t u8g_dev_gprof = { u8g_dev_gprof_fn, &u8g_pb_dev_gprof, 0 };
