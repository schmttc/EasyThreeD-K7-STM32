...
int finish_incremental_LSF(struct linear_fit_data *lsf) {
  ...
  lsf->ybar /= N;
  lsf->zbar /= N;
  lsf->x2bar = lsf->x2bar / N - pow(lsf->xbar,2);
  lsf->y2bar = lsf->y2bar / N - pow(lsf->ybar,2);
  lsf->z2bar = lsf->z2bar / N - pow(lsf->zbar,2);
  lsf->xybar = lsf->xybar / N - lsf->xbar * lsf->ybar;
  lsf->yzbar = lsf->yzbar / N - lsf->ybar * lsf->zbar;
  lsf->xzbar = lsf->xzbar / N - lsf->xbar * lsf->zbar;
  const float DD = lsf->x2bar * lsf->y2bar - pow(lsf->xybar,2);
