...
uint8_t u8g_dev_ssd1306_adafruit_128x64_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
    case 10:
      u8g_InitCom(u8g, dev, 2);
      u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1306_128x64_adafruit3_init_seq);
      break;
    case 11:
      break;
    case 21:
    ...
    case 21:
      {
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1306_128x64_data_start);    
        u8g_WriteByte(u8g, dev, 0x0b0 | (pb->p.page*2));  
        u8g_SetAddress(u8g, dev, 1);            
	u8g_WriteSequence(u8g, dev, pb->width, pb->buf); 
        u8g_SetChipSelect(u8g, dev, 0);
	
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1306_128x64_data_start);    
        u8g_WriteByte(u8g, dev, 0x0b0 | (pb->p.page*2+1));  
        u8g_SetAddress(u8g, dev, 1);            
...
uint8_t u8g_dev_ssd1306_128x64_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x64_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_128x64_sw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_128x64_sw_spi = { u8g_dev_ssd1306_128x64_fn, &u8g_dev_ssd1306_128x64_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_128x64_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x64_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_128x64_hw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_128x64_hw_spi = { u8g_dev_ssd1306_128x64_fn, &u8g_dev_ssd1306_128x64_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_128x64_i2c_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x64_i2c_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_128x64_i2c_buf}; u8g_dev_t u8g_dev_ssd1306_128x64_i2c = { u8g_dev_ssd1306_128x64_fn, &u8g_dev_ssd1306_128x64_i2c_pb, u8g_com_null_fn };

uint8_t u8g_dev_ssd1306_adafruit_128x64_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_adafruit_128x64_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_adafruit_128x64_sw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_adafruit_128x64_sw_spi = { u8g_dev_ssd1306_adafruit_128x64_fn, &u8g_dev_ssd1306_adafruit_128x64_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_adafruit_128x64_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_adafruit_128x64_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_adafruit_128x64_hw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_adafruit_128x64_hw_spi = { u8g_dev_ssd1306_adafruit_128x64_fn, &u8g_dev_ssd1306_adafruit_128x64_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_adafruit_128x64_i2c_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_adafruit_128x64_i2c_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1306_adafruit_128x64_i2c_buf}; u8g_dev_t u8g_dev_ssd1306_adafruit_128x64_i2c = { u8g_dev_ssd1306_adafruit_128x64_fn, &u8g_dev_ssd1306_adafruit_128x64_i2c_pb, u8g_com_null_fn };


uint8_t u8g_dev_ssd1306_128x64_2x_buf[128*2]  ; 
u8g_pb_t u8g_dev_ssd1306_128x64_2x_pb = { {16, 64, 0, 0, 0},  128, u8g_dev_ssd1306_128x64_2x_buf}; 
u8g_dev_t u8g_dev_ssd1306_128x64_2x_sw_spi = { u8g_dev_ssd1306_128x64_2x_fn, &u8g_dev_ssd1306_128x64_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1306_128x64_2x_hw_spi = { u8g_dev_ssd1306_128x64_2x_fn, &u8g_dev_ssd1306_128x64_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1306_128x64_2x_i2c = { u8g_dev_ssd1306_128x64_2x_fn, &u8g_dev_ssd1306_128x64_2x_pb, u8g_com_null_fn };


uint8_t u8g_dev_sh1106_128x64_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_sh1106_128x64_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_sh1106_128x64_sw_spi_buf}; u8g_dev_t u8g_dev_sh1106_128x64_sw_spi = { u8g_dev_sh1106_128x64_fn, &u8g_dev_sh1106_128x64_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_sh1106_128x64_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_sh1106_128x64_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_sh1106_128x64_hw_spi_buf}; u8g_dev_t u8g_dev_sh1106_128x64_hw_spi = { u8g_dev_sh1106_128x64_fn, &u8g_dev_sh1106_128x64_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_sh1106_128x64_i2c_buf[128]  ; u8g_pb_t u8g_dev_sh1106_128x64_i2c_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_sh1106_128x64_i2c_buf}; u8g_dev_t u8g_dev_sh1106_128x64_i2c = { u8g_dev_sh1106_128x64_fn, &u8g_dev_sh1106_128x64_i2c_pb, u8g_com_null_fn };

uint8_t u8g_dev_sh1106_128x64_2x_buf[128*2]  ; 
u8g_pb_t u8g_dev_sh1106_128x64_2x_pb = { {16, 64, 0, 0, 0},  128, u8g_dev_sh1106_128x64_2x_buf}; 
u8g_dev_t u8g_dev_sh1106_128x64_2x_sw_spi = { u8g_dev_sh1106_128x64_2x_fn, &u8g_dev_sh1106_128x64_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_sh1106_128x64_2x_hw_spi = { u8g_dev_sh1106_128x64_2x_fn, &u8g_dev_sh1106_128x64_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_sh1106_128x64_2x_i2c = { u8g_dev_sh1106_128x64_2x_fn, &u8g_dev_sh1106_128x64_2x_pb, u8g_com_null_fn };
