...
static const uint8_t u8g_dev_st7565_64128n_init_seq[]  = {
 	 255, (0xd0 | ((0)&0x0f)),             
	  255, (0xe0 | ((0)&0x0f)),           
	  255, (0xd0 | ((1)&0x0f)),            
	  255, (0xc0 | ((15)&0x0f)),          
...
static const uint8_t u8g_dev_st7565_64128n_data_start[]  = {
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),             
  0x010,	                 
  0x000,		                   
...
static const uint8_t u8g_dev_st7565_64128n_sleep_on[]  = {
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
  0x0ac,		 
  0x000,		                 
    ...
    case 21:
      {
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_st7565_64128n_data_start);    
        u8g_WriteByte(u8g, dev, 0x0b0 | (2*pb->p.page));  
        u8g_SetAddress(u8g, dev, 1);            
	u8g_WriteSequence(u8g, dev, pb->width, pb->buf); 
        u8g_SetChipSelect(u8g, dev, 0);
	
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_st7565_64128n_data_start);    
        u8g_WriteByte(u8g, dev, 0x0b0 | (2*pb->p.page+1));  
        u8g_SetAddress(u8g, dev, 1);            
...
uint8_t u8g_dev_st7565_64128n_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_st7565_64128n_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7565_64128n_sw_spi_buf}; u8g_dev_t u8g_dev_st7565_64128n_sw_spi = { u8g_dev_st7565_64128n_fn, &u8g_dev_st7565_64128n_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7565_64128n_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_st7565_64128n_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7565_64128n_hw_spi_buf}; u8g_dev_t u8g_dev_st7565_64128n_hw_spi = { u8g_dev_st7565_64128n_fn, &u8g_dev_st7565_64128n_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7565_64128n_parallel_buf[128]  ; u8g_pb_t u8g_dev_st7565_64128n_parallel_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7565_64128n_parallel_buf}; u8g_dev_t u8g_dev_st7565_64128n_parallel = { u8g_dev_st7565_64128n_fn, &u8g_dev_st7565_64128n_parallel_pb, u8g_com_null_fn };

uint8_t u8g_dev_st7565_64128n_2x_buf[128*2]  ; 
u8g_pb_t u8g_dev_st7565_64128n_2x_pb = { {16, 64, 0, 0, 0},  128, u8g_dev_st7565_64128n_2x_buf}; 
u8g_dev_t u8g_dev_st7565_64128n_2x_sw_spi = { u8g_dev_st7565_64128n_2x_fn, &u8g_dev_st7565_64128n_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7565_64128n_2x_hw_spi = { u8g_dev_st7565_64128n_2x_fn, &u8g_dev_st7565_64128n_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7565_64128n_2x_hw_parallel = { u8g_dev_st7565_64128n_2x_fn, &u8g_dev_st7565_64128n_2x_pb, u8g_com_null_fn };
