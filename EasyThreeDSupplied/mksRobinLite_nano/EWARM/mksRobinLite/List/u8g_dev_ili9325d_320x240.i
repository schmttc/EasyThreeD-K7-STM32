...
static const uint8_t u8g_dev_ili9325d_320x240_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, ((50) & 0x7f),          
  255, (0xc0 | ((15)&0x0f)),            
  255, ((50) & 0x7f),          
  ...
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x001,                
  255, (0xe0 | ((1)&0x0f)),  0x001, 0x000,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x002,                
  255, (0xe0 | ((1)&0x0f)),  0x002, 0x000,                        
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x003,                
  255, (0xe0 | ((1)&0x0f)),  0x010, 0x030,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x004,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x008,                
  255, (0xe0 | ((1)&0x0f)),  0x002, 0x007,           
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x009,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,           

  255, (0xe0 | ((0)&0x0f)),  0x000, 0x00a,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x00c,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x00d,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,           
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x00f,                 
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x010,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x011,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x007,  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x012,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x013,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x007,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x001,   
  
  255, ((100) & 0x7f),             
  255, ((100) & 0x7f),          
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x010,                
  255, (0xe0 | ((1)&0x0f)),  0x016, 0x090,                
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x011,                
  255, (0xe0 | ((1)&0x0f)),  0x002, 0x027,

  255, ((50) & 0x7f),          
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x012,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x00d,                

  255, ((50) & 0x7f),          
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x013,                
  255, (0xe0 | ((1)&0x0f)),  0x012, 0x000,                
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x029,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x00a,                
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x02b,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x00d,

  255, ((50) & 0x7f),          
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x020,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x021,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,

   
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x030,               
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x031,
  255, (0xe0 | ((1)&0x0f)),  0x004, 0x004,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x032,
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x003,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x035,               
  255, (0xe0 | ((1)&0x0f)),  0x004, 0x005,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x036,               
  255, (0xe0 | ((1)&0x0f)),  0x008, 0x008,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x037,               
  255, (0xe0 | ((1)&0x0f)),  0x004, 0x007,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x038,               
  255, (0xe0 | ((1)&0x0f)),  0x003, 0x003,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x039,               
  255, (0xe0 | ((1)&0x0f)),  0x007, 0x007,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x03c,               
  255, (0xe0 | ((1)&0x0f)),  0x005, 0x004,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x03d,               
  255, (0xe0 | ((1)&0x0f)),  0x008, 0x008,
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x050,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x051,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x0EF,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x052,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x053,                
  255, (0xe0 | ((1)&0x0f)),  0x001, 0x03F,
  
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x060,                
  255, (0xe0 | ((1)&0x0f)),  0x0a7, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x061,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x001,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x06a,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,

  255, (0xe0 | ((0)&0x0f)),  0x000, 0x080,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x081,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x082,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x083,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x084,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x085,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,

  255, (0xe0 | ((0)&0x0f)),  0x000, 0x090,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x010,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x092,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,         

  255, (0xe0 | ((0)&0x0f)),  0x000, 0x007,                
  255, (0xe0 | ((1)&0x0f)),  0x001, 0x033,   
  ...
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x021,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x010,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x022,                
  255, (0xe0 | ((1)&0x0f)),  0x0fe, 0x0fe,
  0x000, 0x000,
  0x0fe, 0x0fe,
  0x000, 0x000,
  0x0fe, 0x0fe,
...
static const uint8_t u8g_dev_ili9325d_320x240_page_seq[]  = {
  255, (0xd0 | ((1)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x020,                
  255, (0xe0 | ((1)&0x0f)),  0x000, 0x000,
  255, (0xe0 | ((0)&0x0f)),  0x000, 0x021,                
...
uint8_t u8g_ili9325d_320x240_8h8_buf[240*4]  ; 
u8g_pb_t u8g_ili9325d_320x240_8h8_pb  = { {4, 240, 0, 0, 0},  240, u8g_ili9325d_320x240_8h8_buf}; 
u8g_dev_t u8g_dev_ili9325d_320x240_8bit  = { u8g_dev_ili9325d_320x240_fn, &u8g_ili9325d_320x240_8h8_pb, u8g_com_arduino_port_d_wr_fn };
