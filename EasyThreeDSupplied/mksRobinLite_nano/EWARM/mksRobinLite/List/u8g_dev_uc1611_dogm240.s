...
//    Endian       =  little
//    Source file  =  
//        F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_uc1611_dogm240.c
//    Command line =  
//        -f C:\Users\ADMINI~1\AppData\Local\Temp\EW4BC0.tmp
//        (F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_uc1611_dogm240.c
...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_uc1611_dogm240.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_uc1611_dogm240_fn
        PUBLIC u8g_dev_uc1611_dogm240_hw_spi
        PUBLIC u8g_dev_uc1611_dogm240_hw_spi_buf
        PUBLIC u8g_dev_uc1611_dogm240_hw_spi_pb
        PUBLIC u8g_dev_uc1611_dogm240_i2c
        PUBLIC u8g_dev_uc1611_dogm240_i2c_buf
        PUBLIC u8g_dev_uc1611_dogm240_i2c_pb
        PUBLIC u8g_dev_uc1611_dogm240_sw_spi
        PUBLIC u8g_dev_uc1611_dogm240_sw_spi_buf
        PUBLIC u8g_dev_uc1611_dogm240_sw_spi_pb
...
//   83   switch(msg)
        MOV      R0,R6
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_uc1611_dogm240_fn_0
        CMP      R0,#+15
        BEQ.N    ??u8g_dev_uc1611_dogm240_fn_1
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_uc1611_dogm240_fn_2
        B.N      ??u8g_dev_uc1611_dogm240_fn_3
//   84   {
//   85     case U8G_DEV_MSG_INIT:
//   86       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_300NS);
??u8g_dev_uc1611_dogm240_fn_0:
        MOVS     R2,#+2
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//   87       u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1611_dogm240_init_seq);
        ADR.N    R2,u8g_dev_uc1611_dogm240_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
??u8g_dev_uc1611_dogm240_fn_3:
        ...
        B.W      u8g_dev_pb8v1_base_fn
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+24
??u8g_dev_uc1611_dogm240_fn_4:
        POP      {R4-R8,PC}       ;; return
??u8g_dev_uc1611_dogm240_fn_2:
        LDR      R8,[R5, #+4]
        Nop      
        ADR.N    R2,u8g_dev_uc1611_dogm240_data_start
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
        LDRB     R2,[R8, #+4]
        ...
        CMP      R0,#+0
        BNE.N    ??u8g_dev_uc1611_dogm240_fn_5
        MOVS     R0,#+0
        B.N      ??u8g_dev_uc1611_dogm240_fn_4
??u8g_dev_uc1611_dogm240_fn_5:
        MOVS     R2,#+1
        MOV      R1,R5
        MOV      R0,R4
...
//  111 }
        ...
        DATA
u8g_dev_uc1611_dogm240_init_seq:
        DC8 255, 209, 255, 224, 241, 63, 242, 0, 243, 63, 129, 183, 192, 2, 163
        DC8 233, 169, 209, 255, 208, 255, 254, 0, 0

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
u8g_dev_uc1611_dogm240_data_start:
...
u8g_dev_uc1611_dogm240_i2c_buf:
        DS8 240

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_pb_t u8g_dev_uc1611_dogm240_i2c_pb
u8g_dev_uc1611_dogm240_i2c_pb:
        DC8 8, 64, 0, 0, 0, 240, 0, 0
        DC32 u8g_dev_uc1611_dogm240_i2c_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_uc1611_dogm240_i2c
u8g_dev_uc1611_dogm240_i2c:
        DC32 u8g_dev_uc1611_dogm240_fn, u8g_dev_uc1611_dogm240_i2c_pb
...
u8g_dev_uc1611_dogm240_sw_spi_buf:
        DS8 240

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_pb_t u8g_dev_uc1611_dogm240_sw_spi_pb
u8g_dev_uc1611_dogm240_sw_spi_pb:
        DC8 8, 64, 0, 0, 0, 240, 0, 0
        DC32 u8g_dev_uc1611_dogm240_sw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_uc1611_dogm240_sw_spi
u8g_dev_uc1611_dogm240_sw_spi:
        DC32 u8g_dev_uc1611_dogm240_fn, u8g_dev_uc1611_dogm240_sw_spi_pb
        DC32 u8g_com_null_fn

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  115 U8G_PB_DEV(u8g_dev_uc1611_dogm240_hw_spi , WIDTH, HEIGHT, PAGE_HEIGHT, u8g_dev_uc1611_dogm240_fn, U8G_COM_HW_SPI);
u8g_dev_uc1611_dogm240_hw_spi_buf:
        DS8 240

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_pb_t u8g_dev_uc1611_dogm240_hw_spi_pb
u8g_dev_uc1611_dogm240_hw_spi_pb:
        DC8 8, 64, 0, 0, 0, 240, 0, 0
        DC32 u8g_dev_uc1611_dogm240_hw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_uc1611_dogm240_hw_spi
u8g_dev_uc1611_dogm240_hw_spi:
        DC32 u8g_dev_uc1611_dogm240_fn, u8g_dev_uc1611_dogm240_hw_spi_pb
        DC32 u8g_com_null_fn
