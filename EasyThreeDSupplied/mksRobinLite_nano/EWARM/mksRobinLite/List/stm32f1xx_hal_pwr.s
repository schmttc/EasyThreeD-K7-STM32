...
//    Endian       =  little
//    Source file  =  
//        F:\nano\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_pwr.c
//    Command line =  
//        -f C:\Users\ADMINI~1\AppData\Local\Temp\EWF8E1.tmp
//        (F:\nano\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_pwr.c -D
...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\stm32f1xx_hal_pwr.s
//
///////////////////////////////////////////////////////////////////////////////
...
HAL_PWR_DeInit:
        LDR.N    R0,??DataTable16  ;; 0x40021010
        LDR      R1,[R0, #+0]
...
HAL_PWR_EnableBkUpAccess:
        MOVS     R0,#+1
        LDR.N    R1,??DataTable16_1  ;; 0x420e0020
        STR      R0,[R1, #+0]
//  191 }
        BX       LR               ;; return
...
HAL_PWR_ConfigPVD:
        LDR.N    R2,??DataTable16_2  ;; 0x40007000
        LDR      R3,[R2, #+0]
        BIC      R3,R3,#0xE0
        LDR      R1,[R0, #+0]
        ORRS     R3,R1,R3
...
//  344   __HAL_PWR_PVD_EXTI_DISABLE_EVENT();
        LDR.N    R1,??DataTable16_3  ;; 0x40010400
        LDR      R2,[R1, #+4]
        BIC      R2,R2,#0x10000
        STR      R2,[R1, #+4]
...
HAL_PWR_EnablePVD:
        MOVS     R0,#+1
        LDR.N    R1,??DataTable16_4  ;; 0x420e0010
        STR      R0,[R1, #+0]
//  381 }
        BX       LR               ;; return
...
HAL_PWR_EnableWakeUpPin:
        ...
        CLZ      R0,R0
        UXTB     R0,R0
        LDR.N    R2,??DataTable16_5  ;; 0x420e0080
        ADD      R2,R2,R0, LSL #+2
        STR      R1,[R2, #+0]
//  406 }
        BX       LR               ;; return
...
//  491   SET_BIT(SCB->SCR, ((uint32_t)SCB_SCR_SLEEPDEEP_Msk));
        LDR.N    R4,??DataTable16_6  ;; 0xe000ed10
        LDR      R0,[R4, #+0]
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+0]
//  492 
...
HAL_PWR_EnterSTANDBYMode:
        LDR.N    R0,??DataTable16_2  ;; 0x40007000
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x2
        STR      R1,[R0, #+0]
//  522 
...
//  598   if(__HAL_PWR_PVD_EXTI_GET_FLAG() != RESET)
        LDR.N    R4,??DataTable16_7  ;; 0x40010414
        LDR      R0,[R4, #+0]
        LSLS     R0,R0,#+15
...
// 
// 420 bytes of CODE memory (+ 2 bytes shared)
//
//Errors: none
//Warnings: none
