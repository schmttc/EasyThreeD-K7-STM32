...
void MX_I2C1_Init(void)
{
  ...
  hi2c1.Instance = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400));
  
  hi2c1.Init.ClockSpeed = 400000;
  hi2c1.Init.DutyCycle = ((uint32_t)0x00000000);
  hi2c1.Init.OwnAddress1 = 0;
  hi2c1.Init.AddressingMode = ((uint32_t)0x00004000);
  hi2c1.Init.DualAddressMode = ((uint32_t)0x00000000);
  hi2c1.Init.OwnAddress2 = 0;
  hi2c1.Init.GeneralCallMode = ((uint32_t)0x00000000);
  hi2c1.Init.NoStretchMode = ((uint32_t)0x00000000);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)))
  {
    ...
    GPIO_InitStruct.Mode = ((uint32_t)0x00000012);
    GPIO_InitStruct.Speed = ((0x3U << (0U)));
    HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStruct);

     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) |= ((0x1U << (21U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) & ((0x1U << (21U)))); ((void)(tmpreg)); } while(0);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR &= ~((0x1U << (21U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0040)|((uint16_t)0x0080));
