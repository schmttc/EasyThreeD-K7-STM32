    ...
    case 21:
      {
        ...
        u8g_WriteByte(u8g, dev, 0x0b8 | pb->p.page);  
...
uint8_t u8g_dev_ks0108_128x64_buf[128]  ; u8g_pb_t u8g_dev_ks0108_128x64_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ks0108_128x64_buf}; u8g_dev_t u8g_dev_ks0108_128x64 = { u8g_dev_ks0108_128x64_fn, &u8g_dev_ks0108_128x64_pb, u8g_com_null_fn };
uint8_t u8g_dev_ks0108_128x64_fast_buf[128]  ; u8g_pb_t u8g_dev_ks0108_128x64_fast_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ks0108_128x64_fast_buf}; u8g_dev_t u8g_dev_ks0108_128x64_fast = { u8g_dev_ks0108_128x64_fn, &u8g_dev_ks0108_128x64_fast_pb, u8g_com_null_fn };
