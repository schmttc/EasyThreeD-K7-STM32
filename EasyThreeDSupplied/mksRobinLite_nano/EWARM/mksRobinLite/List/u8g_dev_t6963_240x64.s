...
//    Endian       =  little
//    Source file  =  
//        F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_t6963_240x64.c
//    Command line =  
//        -f C:\Users\ADMINI~1\AppData\Local\Temp\EW4A72.tmp
//        (F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_t6963_240x64.c
...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_t6963_240x64.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_t6963_240x64_2x_bw_buf
        PUBLIC u8g_dev_t6963_240x64_2x_bw_pb
        PUBLIC u8g_dev_t6963_240x64_8bit
        PUBLIC u8g_dev_t6963_240x64_fn
...
//   63 static const uint8_t u8g_dev_t6963_240x64_init_seq[] PROGMEM = {
...
//  143 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_t6963_240x64_fn
        THUMB
//  144 uint8_t u8g_dev_t6963_240x64_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
//  145 {
...
//  146   switch(msg)
        MOV      R0,R7
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_t6963_240x64_fn_0
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_t6963_240x64_fn_1
        B.N      ??u8g_dev_t6963_240x64_fn_2
//  147   {
//  148     case U8G_DEV_MSG_INIT:
//  149       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_NONE);    
??u8g_dev_t6963_240x64_fn_0:
        MOVS     R2,#+255
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//  150       u8g_WriteEscSeqP(u8g, dev, u8g_dev_t6963_240x64_init_seq);
        ADR.N    R2,u8g_dev_t6963_240x64_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
//  168         for( i = 0; i < PAGE_HEIGHT; i ++ )
        MOV      R10,#+0
        B.N      ??u8g_dev_t6963_240x64_fn_3
//  169         {
//  170           u8g_SetAddress(u8g, dev, 0);           /* data mode */
??u8g_dev_t6963_240x64_fn_4:
        MOVS     R2,#+0
        MOV      R1,R5
        MOV      R0,R4
          CFI FunCall u8g_SetAddress
...
//  180         }
        ADD      R10,R10,#+1
??u8g_dev_t6963_240x64_fn_3:
        MOV      R0,R10
        UXTB     R0,R0
        CMP      R0,#+16
        BLT.N    ??u8g_dev_t6963_240x64_fn_4
...
u8g_dev_t6963_240x64_init_seq:
        ...
        DC8 254, 0, 0, 0
//  188 
//  189 // U8G_PB_DEV(u8g_dev_t6963_240x64_8bit, WIDTH, HEIGHT, PAGE_HEIGHT, u8g_dev_t6963_240x64_fn, U8G_COM_T6963);
//  190 

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  191 uint8_t u8g_dev_t6963_240x64_2x_bw_buf[WIDTH/8*PAGE_HEIGHT] U8G_NOCOMMON ; 
u8g_dev_t6963_240x64_2x_bw_buf:
        DS8 480

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
//  192 u8g_pb_t u8g_dev_t6963_240x64_2x_bw_pb = { {PAGE_HEIGHT, HEIGHT, 0, 0, 0},  WIDTH, u8g_dev_t6963_240x64_2x_bw_buf}; 
u8g_dev_t6963_240x64_2x_bw_pb:
        DC8 16, 64, 0, 0, 0, 240, 0, 0
        DC32 u8g_dev_t6963_240x64_2x_bw_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
//  193 u8g_dev_t u8g_dev_t6963_240x64_8bit = { u8g_dev_t6963_240x64_fn, &u8g_dev_t6963_240x64_2x_bw_pb, U8G_COM_T6963 };
u8g_dev_t6963_240x64_8bit:
        DC32 u8g_dev_t6963_240x64_fn, u8g_dev_t6963_240x64_2x_bw_pb
