...
static const uint8_t u8g_dev_st7687_c144mvgd_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
  255, (0xc0 | ((15)&0x0f)),            
    ...
    case 21:
      {
        ...
        u8g_WriteByte(u8g, dev, 128-1 );       
        u8g_SetAddress(u8g, dev, 0);            
        u8g_WriteByte(u8g, dev, 0x02b );       
        u8g_SetAddress(u8g, dev, 1);            
        u8g_WriteByte(u8g, dev, y );       
        u8g_WriteByte(u8g, dev, y+8-1 );       
        u8g_SetAddress(u8g, dev, 0);            
...
uint8_t u8g_st7687_c144mvgd_8h8_buf[128*8]  ; 
u8g_pb_t u8g_st7687_c144mvgd_8h8_pb = { {8, 128, 0, 0, 0},  128, u8g_st7687_c144mvgd_8h8_buf}; 

u8g_dev_t u8g_dev_st7687_c144mvgd_sw_spi = { u8g_dev_st7687_c144mvgd_fn, &u8g_st7687_c144mvgd_8h8_pb, u8g_com_arduino_sw_spi_fn };

u8g_dev_t u8g_dev_st7687_c144mvgd_8bit = { u8g_dev_st7687_c144mvgd_fn, &u8g_st7687_c144mvgd_8h8_pb, u8g_com_null_fn };
