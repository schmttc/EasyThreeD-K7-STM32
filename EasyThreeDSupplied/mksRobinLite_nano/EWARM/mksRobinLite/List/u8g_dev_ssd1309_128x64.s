...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_ssd1309_128x64.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_ssd1309_128x64_fn
        PUBLIC u8g_dev_ssd1309_128x64_hw_spi
        PUBLIC u8g_dev_ssd1309_128x64_hw_spi_buf
        PUBLIC u8g_dev_ssd1309_128x64_hw_spi_pb
        PUBLIC u8g_dev_ssd1309_128x64_i2c
        PUBLIC u8g_dev_ssd1309_128x64_i2c_buf
        PUBLIC u8g_dev_ssd1309_128x64_i2c_pb
        PUBLIC u8g_dev_ssd1309_128x64_sw_spi
        PUBLIC u8g_dev_ssd1309_128x64_sw_spi_buf
        PUBLIC u8g_dev_ssd1309_128x64_sw_spi_pb
...
//  101 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_ssd1309_128x64_fn
        THUMB
...
//  104   switch(msg)
        MOV      R0,R6
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_ssd1309_128x64_fn_0
        CMP      R0,#+15
        BEQ.N    ??u8g_dev_ssd1309_128x64_fn_1
        CMP      R0,#+16
        BEQ.N    ??u8g_dev_ssd1309_128x64_fn_2
        CMP      R0,#+17
        BEQ.N    ??u8g_dev_ssd1309_128x64_fn_3
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_ssd1309_128x64_fn_4
        B.N      ??u8g_dev_ssd1309_128x64_fn_5
//  105   {
//  106     case U8G_DEV_MSG_INIT:
//  107       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_300NS);
??u8g_dev_ssd1309_128x64_fn_0:
        MOVS     R2,#+2
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//  108       u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1309_128x64_init_seq);
        ADR.N    R2,u8g_dev_ssd1309_128x64_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
??u8g_dev_ssd1309_128x64_fn_5:
        ...
        B.W      u8g_dev_pb8v1_base_fn
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+24
??u8g_dev_ssd1309_128x64_fn_6:
        POP      {R4-R8,PC}       ;; return
??u8g_dev_ssd1309_128x64_fn_4:
        LDR      R8,[R5, #+4]
        Nop      
        ADR.N    R2,u8g_dev_ssd1309_128x64_data_start
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
        LDRB     R2,[R8, #+4]
        ...
        CMP      R0,#+0
        BNE.N    ??u8g_dev_ssd1309_128x64_fn_7
        MOVS     R0,#+0
        B.N      ??u8g_dev_ssd1309_128x64_fn_6
??u8g_dev_ssd1309_128x64_fn_7:
        MOVS     R2,#+0
        MOV      R1,R5
        MOV      R0,R4
...
u8g_dev_ssd1309_128x64_init_seq:
        DC8 255, 208, 255, 224, 255, 193, 255, 209, 253, 18, 174, 213, 160, 168
        DC8 63, 61, 0, 64, 161, 200, 218, 18, 129, 223, 217, 130, 219, 52, 164
        DC8 166, 255, 191, 255, 50, 175, 255, 50, 255, 208, 255, 254, 0, 0, 0
...
u8g_dev_ssd1309_128x64_hw_spi_pb:
        ...
        DC32 u8g_dev_ssd1309_128x64_hw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1309_128x64_hw_spi
u8g_dev_ssd1309_128x64_hw_spi:
        DC32 u8g_dev_ssd1309_128x64_fn, u8g_dev_ssd1309_128x64_hw_spi_pb
...
u8g_dev_ssd1309_128x64_sw_spi_pb:
        DC8 8, 64, 0, 0, 0, 128, 0, 0
        DC32 u8g_dev_ssd1309_128x64_sw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1309_128x64_sw_spi
u8g_dev_ssd1309_128x64_sw_spi:
        DC32 u8g_dev_ssd1309_128x64_fn, u8g_dev_ssd1309_128x64_sw_spi_pb
        DC32 u8g_com_null_fn
...
u8g_dev_ssd1309_128x64_i2c_pb:
        DC8 8, 64, 0, 0, 0, 128, 0, 0
        DC32 u8g_dev_ssd1309_128x64_i2c_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1309_128x64_i2c
u8g_dev_ssd1309_128x64_i2c:
        DC32 u8g_dev_ssd1309_128x64_fn, u8g_dev_ssd1309_128x64_i2c_pb
        DC32 u8g_com_null_fn
