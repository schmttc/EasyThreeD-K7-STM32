...
void print_hex_nybble(const uint8_t n)       { {if(!from_wifi_flag){customizedSerial . write(hex_nybble(n));}else{serial2 . print(hex_nybble(n));}};  }
void print_hex_byte(const uint8_t b)         { {if(!from_wifi_flag){customizedSerial . print(hex_byte(b));}else{serial2 . print(hex_byte(b));}};    }
void print_hex_word(const uint16_t w)        { {if(!from_wifi_flag){customizedSerial . print(hex_word(w));}else{serial2 . print(hex_word(w));}};    }
