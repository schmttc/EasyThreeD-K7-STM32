...
static const uint8_t u8g_dev_dogs102_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((1)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
...
static const uint8_t u8g_dev_dogs102_data_start[]  = {
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
  0x010,		 
  0x000,		       
...
uint8_t u8g_dev_uc1701_dogs102_sw_spi_buf[102]  ; u8g_pb_t u8g_dev_uc1701_dogs102_sw_spi_pb = { {8, 64, 0, 0, 0}, 102, u8g_dev_uc1701_dogs102_sw_spi_buf}; u8g_dev_t u8g_dev_uc1701_dogs102_sw_spi = { u8g_dev_dogs102_fn, &u8g_dev_uc1701_dogs102_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_uc1701_dogs102_hw_spi_buf[102]  ; u8g_pb_t u8g_dev_uc1701_dogs102_hw_spi_pb = { {8, 64, 0, 0, 0}, 102, u8g_dev_uc1701_dogs102_hw_spi_buf}; u8g_dev_t u8g_dev_uc1701_dogs102_hw_spi = { u8g_dev_dogs102_fn, &u8g_dev_uc1701_dogs102_hw_spi_pb, u8g_com_null_fn };

uint8_t u8g_dev_uc1701_dogs102_2x_buf[102*2]  ; 
u8g_pb_t u8g_dev_uc1701_dogs102_2x_pb = { {16, 64, 0, 0, 0},  102, u8g_dev_uc1701_dogs102_2x_buf}; 
u8g_dev_t u8g_dev_uc1701_dogs102_2x_sw_spi = { u8g_dev_uc1701_dogs102_2x_fn, &u8g_dev_uc1701_dogs102_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_uc1701_dogs102_2x_hw_spi = { u8g_dev_uc1701_dogs102_2x_fn, &u8g_dev_uc1701_dogs102_2x_pb, u8g_com_null_fn };
