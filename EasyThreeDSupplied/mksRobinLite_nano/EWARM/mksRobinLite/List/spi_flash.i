...
{
	u16 Temp = 0;	  
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(12<<2))))=0;				    
	...
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(12<<2))))=1;				    
	return Temp;
}   		    
  ...
  *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(12<<2))))=0;
  ...
  if(1)	                
  {
    while (NumByteToRead--)  
    {
      ...
      *pBuffer = SPI_FLASH_SendByte(0xA5);
  ...
  {
      HAL_SPI_Receive_DMA(&hspi2, pBuffer, NumByteToRead);      
      while(hdma_spi2_rx.State ==HAL_DMA_STATE_BUSY);          
...
u8 SPI_FLASH_ReadByte(void)
{
  return (SPI_FLASH_SendByte(0xA5));
}
...
u8 SPI_FLASH_SendByte(u8 byte)
{
  ...
  SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), byte);
...
u16 SPI_FLASH_SendHalfWord(u16 HalfWord)
{
  ...
  SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), HalfWord);
