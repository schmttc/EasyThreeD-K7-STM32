...
{		
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0040)|((uint16_t)0x0080), GPIO_PIN_SET);
	
}

void IIC_Start(void)
{
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0X0FFFFFFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=(u32)3<<28;};     
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(7<<2))))=1;	  	  
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(6<<2))))=1;
	delay_us(4);
 	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(7<<2))))=0;
	delay_us(4);
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(6<<2))))=0;
}	  
...
{
	uint8_t ucErrTime=0;
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0X0FFFFFFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=(u32)8<<28;};      
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(7<<2))))=1;delay_us(1);	   
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(6<<2))))=1;delay_us(1);	 
	while(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(7<<2)))))
	{
		ucErrTime++;
		if(ucErrTime>250)
		{
...
uint8_t IIC_Read_Byte(unsigned char ack)
{
    ...
    for(i=0;i<8;i++ )
	{
		...
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(6<<2))))=1;
        receive<<=1;
        if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(7<<2)))))receive++;   
		delay_us(1); 
    }					 
    if (!ack)
        IIC_NAck();
