...
//    Endian       =  little
//    Source file  =  
//        F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_lc7981_240x64.c
//    Command line =  
//        -f C:\Users\ADMINI~1\AppData\Local\Temp\EW43B0.tmp
//        (F:\nano\Middlewares\Third_Party\u8glib_arm_v1.17\src\u8g_dev_lc7981_240x64.c
...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_lc7981_240x64.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_lc7981_240x64_8bit
        PUBLIC u8g_dev_lc7981_240x64_8bit_buf
        PUBLIC u8g_dev_lc7981_240x64_8bit_pb
        PUBLIC u8g_dev_lc7981_240x64_fn
...
//    1 /*
//    2 
//    3   u8g_dev_lc7981_240x64.c
//    4   
//    5   Tested with Nan Ya LM_J6_003_
//    6   
...
//   45 
//   46 /*
//   47   http://www.mark-products.com/graphics.htm#240x64%20Pixel%20Format
//   48 */
//   49 
//   50 static const uint8_t u8g_dev_lc7981_240x64_init_seq[] PROGMEM = {
...
//   93 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_lc7981_240x64_fn
        THUMB
//   94 uint8_t u8g_dev_lc7981_240x64_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
//   95 {
...
//   96   switch(msg)
        MOV      R0,R7
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_lc7981_240x64_fn_0
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_lc7981_240x64_fn_1
        B.N      ??u8g_dev_lc7981_240x64_fn_2
//   97   {
//   98     case U8G_DEV_MSG_INIT:
//   99       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_NONE);
??u8g_dev_lc7981_240x64_fn_0:
        MOVS     R2,#+255
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//  100       u8g_WriteEscSeqP(u8g, dev, u8g_dev_lc7981_240x64_init_seq);
        ADR.N    R2,u8g_dev_lc7981_240x64_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
//  117         for( i = 0; i < 8; i ++ )
        MOV      R10,#+0
        B.N      ??u8g_dev_lc7981_240x64_fn_3
//  118         {
//  119           u8g_SetAddress(u8g, dev, 1);           /* cmd mode */
??u8g_dev_lc7981_240x64_fn_4:
        MOVS     R2,#+1
        MOV      R1,R5
        MOV      R0,R4
          CFI FunCall u8g_SetAddress
...
//  135         }
        ADD      R10,R10,#+1
??u8g_dev_lc7981_240x64_fn_3:
        MOV      R0,R10
        UXTB     R0,R0
        CMP      R0,#+8
        BLT.N    ??u8g_dev_lc7981_240x64_fn_4
...
//  142 
        ...
        DATA
//  143 U8G_PB_DEV(u8g_dev_lc7981_240x64_8bit, WIDTH, HEIGHT, PAGE_HEIGHT, u8g_dev_lc7981_240x64_fn, U8G_COM_FAST_PARALLEL);
u8g_dev_lc7981_240x64_8bit_buf:
        DS8 240

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_pb_t u8g_dev_lc7981_240x64_8bit_pb
u8g_dev_lc7981_240x64_8bit_pb:
        DC8 8, 64, 0, 0, 0, 240, 0, 0
        DC32 u8g_dev_lc7981_240x64_8bit_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_lc7981_240x64_8bit
u8g_dev_lc7981_240x64_8bit:
        DC32 u8g_dev_lc7981_240x64_fn, u8g_dev_lc7981_240x64_8bit_pb
