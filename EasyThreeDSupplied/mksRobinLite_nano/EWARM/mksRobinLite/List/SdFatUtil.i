...
void SdFatUtil::print_P(const char * str) {
  for (uint8_t c; (c = (*(const unsigned char *)(str))); str++) customizedSerial .write(c);
}
...
void SdFatUtil::println_P(const char * str) {
  print_P(str);
...
void SdFatUtil::SerialPrint_P(const char * str) {
  print_P(str);
}
...
void SdFatUtil::SerialPrintln_P(const char * str) {
  println_P(str);
}
