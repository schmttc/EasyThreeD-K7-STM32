...
static const uint8_t u8g_dev_st7920_202x32_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((15)&0x0f)),            
  255, ((100) & 0x7f),          
    ...
    case 21:
      {
        ...
        for( i = 0; i < 8; i ++ )
        {
          ...
          u8g_WriteSequence(u8g, dev, 202/8, ptr);
          ptr += 202/8;
          y++;
        }
...
uint8_t u8g_dev_st7920_202x32_sw_spi_buf[202]  ; u8g_pb_t u8g_dev_st7920_202x32_sw_spi_pb = { {8, 32, 0, 0, 0}, 202, u8g_dev_st7920_202x32_sw_spi_buf}; u8g_dev_t u8g_dev_st7920_202x32_sw_spi = { u8g_dev_st7920_202x32_fn, &u8g_dev_st7920_202x32_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7920_202x32_hw_spi_buf[202]  ; u8g_pb_t u8g_dev_st7920_202x32_hw_spi_pb = { {8, 32, 0, 0, 0}, 202, u8g_dev_st7920_202x32_hw_spi_buf}; u8g_dev_t u8g_dev_st7920_202x32_hw_spi = { u8g_dev_st7920_202x32_fn, &u8g_dev_st7920_202x32_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7920_202x32_8bit_buf[202]  ; u8g_pb_t u8g_dev_st7920_202x32_8bit_pb = { {8, 32, 0, 0, 0}, 202, u8g_dev_st7920_202x32_8bit_buf}; u8g_dev_t u8g_dev_st7920_202x32_8bit = { u8g_dev_st7920_202x32_fn, &u8g_dev_st7920_202x32_8bit_pb, u8g_com_null_fn };

uint8_t u8g_dev_st7920_202x32_4x_buf[(202*4)]  ; 
u8g_pb_t u8g_dev_st7920_202x32_4x_pb = { {32, 32, 0, 0, 0},  202, u8g_dev_st7920_202x32_4x_buf}; 
u8g_dev_t u8g_dev_st7920_202x32_4x_sw_spi = { u8g_dev_st7920_202x32_4x_fn, &u8g_dev_st7920_202x32_4x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7920_202x32_4x_hw_spi = { u8g_dev_st7920_202x32_4x_fn, &u8g_dev_st7920_202x32_4x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7920_202x32_4x_8bit = { u8g_dev_st7920_202x32_4x_fn, &u8g_dev_st7920_202x32_4x_pb, u8g_com_null_fn };
