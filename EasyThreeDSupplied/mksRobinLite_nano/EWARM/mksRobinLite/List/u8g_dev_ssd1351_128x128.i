...
static const uint8_t u8g_dev_ssd1351_128x128_init_seq[]  = {
	255, (0xd0 | ((0)&0x0f)),					 
	255, ((50) & 0x7f),
	255, (0xe0 | ((0)&0x0f)),					 
	255, (0xc0 | ((1)&0x0f)),					 
...
static const uint8_t u8g_dev_ssd1351_128x128gh_init_seq[]  = {
	255, (0xd0 | ((0)&0x0f)),					 
	255, ((50) & 0x7f),
	255, (0xe0 | ((0)&0x0f)),					 
	255, (0xc0 | ((1)&0x0f)),					 
...
static const uint8_t u8g_dev_ssd1351_128x128_column_seq[]  = {
	255, (0xd0 | ((1)&0x0f)),
	255, (0xe0 | ((0)&0x0f)), 0x15,
	255, (0xe0 | ((1)&0x0f)), 0x00, 0x7f,
	255, (0xe0 | ((0)&0x0f)), 0x75,
	255, (0xe0 | ((1)&0x0f)), 0x00, 0x7f,
	255, (0xe0 | ((0)&0x0f)), 0x5c,
	255, (0xe0 | ((1)&0x0f)),
	255, (0xd0 | ((0)&0x0f)),
	255, 254
};

static uint8_t u8g_ssd1351_stream_bytes[8*3];
	...
	case 21:
		{
			...
			for( i = 0; i < page_height; i++ )
			{
			  ...
			  for (x = 0; x < pb->width; x+=8)
			  {
			    u8g_ssd1351_to_stream(ptr);
			    u8g_WriteSequence(u8g, dev, 8*3, u8g_ssd1351_stream_bytes);
			    ptr += 8;
			  }
			}
...
uint8_t u8g_dev_ssd1351_128x128_byte_buf[128*8]  ; 

u8g_pb_t u8g_dev_ssd1351_128x128_byte_pb = { {8, 128, 0, 0, 0},  128, u8g_dev_ssd1351_128x128_byte_buf};  
u8g_dev_t u8g_dev_ssd1351_128x128_332_sw_spi = { u8g_dev_ssd1351_128x128_332_fn, &u8g_dev_ssd1351_128x128_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128_332_hw_spi = { u8g_dev_ssd1351_128x128_332_fn, &u8g_dev_ssd1351_128x128_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_332_sw_spi = { u8g_dev_ssd1351_128x128gh_332_fn, &u8g_dev_ssd1351_128x128_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_332_hw_spi = { u8g_dev_ssd1351_128x128gh_332_fn, &u8g_dev_ssd1351_128x128_byte_pb, u8g_com_null_fn };
...
u8g_pb_t u8g_dev_ssd1351_128x128_hicolor_byte_pb = { {8/2, 128, 0, 0, 0},  128, u8g_dev_ssd1351_128x128_byte_buf}; 
u8g_dev_t u8g_dev_ssd1351_128x128_hicolor_sw_spi = { u8g_dev_ssd1351_128x128_hicolor_fn, &u8g_dev_ssd1351_128x128_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128_hicolor_hw_spi = { u8g_dev_ssd1351_128x128_hicolor_fn, &u8g_dev_ssd1351_128x128_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_hicolor_sw_spi = { u8g_dev_ssd1351_128x128gh_hicolor_fn, &u8g_dev_ssd1351_128x128_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_hicolor_hw_spi = { u8g_dev_ssd1351_128x128gh_hicolor_fn, &u8g_dev_ssd1351_128x128_hicolor_byte_pb, u8g_com_null_fn };


uint8_t u8g_dev_ssd1351_128x128_4x_byte_buf[128*8*4]  ; 

u8g_pb_t u8g_dev_ssd1351_128x128_4x_332_byte_pb = { {8*4, 128, 0, 0, 0},  128, u8g_dev_ssd1351_128x128_4x_byte_buf};  
u8g_dev_t u8g_dev_ssd1351_128x128_4x_332_sw_spi = { u8g_dev_ssd1351_128x128_332_fn, &u8g_dev_ssd1351_128x128_4x_332_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128_4x_332_hw_spi = { u8g_dev_ssd1351_128x128_332_fn, &u8g_dev_ssd1351_128x128_4x_332_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_4x_332_sw_spi = { u8g_dev_ssd1351_128x128gh_332_fn, &u8g_dev_ssd1351_128x128_4x_332_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_4x_332_hw_spi = { u8g_dev_ssd1351_128x128gh_332_fn, &u8g_dev_ssd1351_128x128_4x_332_byte_pb, u8g_com_null_fn };

u8g_pb_t u8g_dev_ssd1351_128x128_4x_hicolor_byte_pb = { {8/2*4, 128, 0, 0, 0},  128, u8g_dev_ssd1351_128x128_4x_byte_buf}; 
u8g_dev_t u8g_dev_ssd1351_128x128_4x_hicolor_sw_spi = { u8g_dev_ssd1351_128x128_hicolor_fn, &u8g_dev_ssd1351_128x128_4x_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128_4x_hicolor_hw_spi = { u8g_dev_ssd1351_128x128_hicolor_fn, &u8g_dev_ssd1351_128x128_4x_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_4x_hicolor_sw_spi = { u8g_dev_ssd1351_128x128gh_hicolor_fn, &u8g_dev_ssd1351_128x128_4x_hicolor_byte_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1351_128x128gh_4x_hicolor_hw_spi = { u8g_dev_ssd1351_128x128gh_hicolor_fn, &u8g_dev_ssd1351_128x128_4x_hicolor_byte_pb, u8g_com_null_fn };
