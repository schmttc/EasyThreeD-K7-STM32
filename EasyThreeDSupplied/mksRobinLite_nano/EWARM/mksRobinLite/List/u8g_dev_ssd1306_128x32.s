...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_ssd1306_128x32.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_ssd1306_128x32_2x_buf
        PUBLIC u8g_dev_ssd1306_128x32_2x_fn
        PUBLIC u8g_dev_ssd1306_128x32_2x_hw_spi
        PUBLIC u8g_dev_ssd1306_128x32_2x_i2c
        PUBLIC u8g_dev_ssd1306_128x32_2x_pb
        PUBLIC u8g_dev_ssd1306_128x32_2x_sw_spi
        PUBLIC u8g_dev_ssd1306_128x32_fn
        PUBLIC u8g_dev_ssd1306_128x32_hw_spi
        PUBLIC u8g_dev_ssd1306_128x32_hw_spi_buf
        PUBLIC u8g_dev_ssd1306_128x32_hw_spi_pb
        PUBLIC u8g_dev_ssd1306_128x32_i2c
        PUBLIC u8g_dev_ssd1306_128x32_i2c_buf
        PUBLIC u8g_dev_ssd1306_128x32_i2c_pb
        PUBLIC u8g_dev_ssd1306_128x32_sw_spi
        PUBLIC u8g_dev_ssd1306_128x32_sw_spi_buf
        PUBLIC u8g_dev_ssd1306_128x32_sw_spi_pb
...
//  211 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_ssd1306_128x32_fn
        THUMB
...
//  214   switch(msg)
        MOV      R0,R6
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_ssd1306_128x32_fn_0
        CMP      R0,#+16
        BEQ.N    ??u8g_dev_ssd1306_128x32_fn_1
        CMP      R0,#+17
        BEQ.N    ??u8g_dev_ssd1306_128x32_fn_2
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_ssd1306_128x32_fn_3
        B.N      ??u8g_dev_ssd1306_128x32_fn_4
//  215   {
//  216     case U8G_DEV_MSG_INIT:
//  217       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_300NS);
??u8g_dev_ssd1306_128x32_fn_0:
        MOVS     R2,#+2
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//  218       u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1306_128x32_init_seq);
        ADR.N    R2,u8g_dev_ssd1306_128x32_adafruit3_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
??u8g_dev_ssd1306_128x32_fn_4:
        ...
        B.W      u8g_dev_pb8v1_base_fn
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+24
??u8g_dev_ssd1306_128x32_fn_5:
        POP      {R4-R8,PC}       ;; return
??u8g_dev_ssd1306_128x32_fn_3:
        LDR      R8,[R5, #+4]
        Nop      
        ADR.N    R2,u8g_dev_ssd1306_128x32_data_start
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
        LDRB     R2,[R8, #+4]
        ...
        CMP      R0,#+0
        BNE.N    ??u8g_dev_ssd1306_128x32_fn_6
        MOVS     R0,#+0
        B.N      ??u8g_dev_ssd1306_128x32_fn_5
??u8g_dev_ssd1306_128x32_fn_6:
        MOVS     R2,#+0
        MOV      R1,R5
        MOV      R0,R4
...
//  243 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_ssd1306_128x32_2x_fn
        THUMB
...
//  246   switch(msg)
        MOV      R0,R6
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_ssd1306_128x32_2x_fn_0
        CMP      R0,#+16
        BEQ.N    ??u8g_dev_ssd1306_128x32_2x_fn_1
        CMP      R0,#+17
        BEQ.N    ??u8g_dev_ssd1306_128x32_2x_fn_2
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_ssd1306_128x32_2x_fn_3
        B.N      ??u8g_dev_ssd1306_128x32_2x_fn_4
//  247   {
//  248     case U8G_DEV_MSG_INIT:
//  249       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_300NS);
??u8g_dev_ssd1306_128x32_2x_fn_0:
        MOVS     R2,#+2
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
...
??u8g_dev_ssd1306_128x32_2x_fn_4:
        MOV      R3,R7
        MOV      R2,R6
        MOV      R1,R5
        MOV      R0,R4
        ...
        B.W      u8g_dev_pb16v1_base_fn
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+32
??u8g_dev_ssd1306_128x32_2x_fn_5:
        POP      {R1,R4-R9,PC}    ;; return
??u8g_dev_ssd1306_128x32_2x_fn_3:
        LDR      R8,[R5, #+4]
        ADR.W    R9,u8g_dev_ssd1306_128x32_data_start
        MOV      R2,R9
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
        ...
        BL       u8g_SetChipSelect
        B.N      ??u8g_dev_ssd1306_128x32_2x_fn_4
??u8g_dev_ssd1306_128x32_2x_fn_1:
        Nop      
        ADR.N    R2,u8g_dev_ssd13xx_sleep_on
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
        MOVS     R0,#+1
        B.N      ??u8g_dev_ssd1306_128x32_2x_fn_5
??u8g_dev_ssd1306_128x32_2x_fn_2:
        ADR.N    R2,u8g_dev_ssd13xx_sleep_off
        MOV      R0,R4
          CFI FunCall u8g_WriteEscSeqP
        BL       u8g_WriteEscSeqP
...
u8g_dev_ssd1306_128x32_adafruit3_init_seq:
        DC8 255, 208, 255, 224, 255, 193, 255, 209, 174, 213, 128, 168, 31, 211
        DC8 0, 64, 141, 20, 32, 2, 161, 200, 218, 2, 129, 207, 217, 241, 219
...
u8g_dev_ssd1306_128x32_sw_spi_pb:
        ...
        DC32 u8g_dev_ssd1306_128x32_sw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1306_128x32_sw_spi
u8g_dev_ssd1306_128x32_sw_spi:
        DC32 u8g_dev_ssd1306_128x32_fn, u8g_dev_ssd1306_128x32_sw_spi_pb
...
u8g_dev_ssd1306_128x32_hw_spi_pb:
        DC8 8, 32, 0, 0, 0, 128, 0, 0
        DC32 u8g_dev_ssd1306_128x32_hw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1306_128x32_hw_spi
u8g_dev_ssd1306_128x32_hw_spi:
        DC32 u8g_dev_ssd1306_128x32_fn, u8g_dev_ssd1306_128x32_hw_spi_pb
        DC32 u8g_com_null_fn
...
u8g_dev_ssd1306_128x32_i2c_pb:
        DC8 8, 32, 0, 0, 0, 128, 0, 0
        DC32 u8g_dev_ssd1306_128x32_i2c_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_ssd1306_128x32_i2c
u8g_dev_ssd1306_128x32_i2c:
        DC32 u8g_dev_ssd1306_128x32_fn, u8g_dev_ssd1306_128x32_i2c_pb
        DC32 u8g_com_null_fn
//  284 
...
u8g_dev_ssd1306_128x32_2x_pb:
        ...
        DC32 u8g_dev_ssd1306_128x32_2x_buf
...
u8g_dev_ssd1306_128x32_2x_sw_spi:
        DC32 u8g_dev_ssd1306_128x32_2x_fn, u8g_dev_ssd1306_128x32_2x_pb
        DC32 u8g_com_null_fn
