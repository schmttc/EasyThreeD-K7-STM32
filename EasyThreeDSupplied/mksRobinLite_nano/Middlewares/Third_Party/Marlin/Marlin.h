...
#define PSTR(x)          (x)
#define SERIAL_PROTOCOL_N(x,n) (MYSERIAL.printn(x,n))

#define constexpr const         /*--mks--*/
...
#if 1
  extern int bilinear_grid_spacing[2], bilinear_start[2];	/*---mks---*/ //int to int16_t
...
#if FAN_COUNT > 0
  //extern int16_t fanSpeeds[FAN_COUNT];	/*--mks--*/
