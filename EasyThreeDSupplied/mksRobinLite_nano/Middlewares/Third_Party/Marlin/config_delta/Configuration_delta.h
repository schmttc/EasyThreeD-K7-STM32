...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 217.5 // mm * 1

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 144.0 // mm *

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 25.0 // mm * 3

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 17.0 // mm * 4
  ...
  #define DELTA_HEIGHT 120 // get this value from auto calibrate - use G33 C-1 at 1st time calibration
  ...
  #define DELTA_CALIBRATION_RADIUS (DELTA_PRINTABLE_RADIUS - 27) // mm
