...
//#define START_BMPHIGH
    ...
    //#define LITE_MARLIN_LOGO       //Marlin Logo
    //#define LITE_MAKERBASE_LOGO    //Makerbase Logo
    //#define LITE_REPRAP_LOGO       //RepRap Logo
   //#define LITE_DAKUN_LOGO        //大昆 Logo
   //#define LITE_LUOGEN_LOGO        //洛根 Logo
   //#define LITE_R3D_LOGO             //R3D Logo
  //#define LITE_MAYI_LOGO           //蚂蚁三维Logo
  #define LITE_PLT_LOGO           //普偺特  Logo

    #if defined(LITE_MARLIN_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_marlin_logo.h"
    #elif defined(LITE_MAKERBASE_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_makerbase_logo.h"
    #elif defined(LITE_REPRAP_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_reprap_logo.h"
    #elif defined(LITE_DAKUN_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_dakun_logo.h"
    #elif defined(LITE_LUOGEN_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_luogen_logo.h"
    #elif defined(LITE_R3D_LOGO)
       //#define LOGO_START_Y  12
       #include "lite_r3d_logo.h"
    #elif defined(LITE_MAYI_LOGO)
       #define LOGO_START_Y  0
       #include "lite_mayi_logo.h"
    #elif defined(LITE_PLT_LOGO)
       #define LOGO_START_Y 0
       #include "lite_plt_logo.h"
    #endif  
...
/*
    ...
    const unsigned char start_bmp[START_BMPBYTES] PROGMEM = {	//mks marlin logo bmp
      //Marlin Logo
...
//#if HAS_TEMP_BED 
#ifndef LITE_LUOGEN_LOGO
#define MKS_BMP_START_X 9
#define MKS_BMP_START_Y 1
#define MKS_TEMP_START_X 5
#if 1 				/*--mks cfg-- HAS_TEMP_BED --*/
  #if HOTENDS == 1
    ...
    //const unsigned char status_screen1_bmp[] PROGMEM = { //AVR-GCC, WinAVR
     unsigned char status_screen1_bmp[285]  = { //AVR-GCC, WinAVR
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xFF, 0xE0,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0xE0,
...
#else
    #define MKS_BMP_START_X 0
    #define MKS_BMP_START_Y 0
    #define MKS_TEMP_START_X 57
#endif
