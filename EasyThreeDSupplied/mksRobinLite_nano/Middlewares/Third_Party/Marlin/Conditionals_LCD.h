...
//      #define TEST_BLTOUCH() _TEST_BLTOUCH(Z_MIN)	//mks
	  #define TEST_BLTOUCH() (READ(Z_MIN_PIN) != Z_MIN_ENDSTOP_INVERTING)
    #else
      //#define TEST_BLTOUCH() _TEST_BLTOUCH(Z_MIN_PROBE)	//mks
      #define TEST_BLTOUCH() (READ(Z_MIN_PROBE_PIN) != Z_MIN_PROBE_ENDSTOP_INVERTING)
    #endif
  #endif
  ...
  //#define HAS_SOFTWARE_ENDSTOPS (ENABLED(MIN_SOFTWARE_ENDSTOPS) || ENABLED(MAX_SOFTWARE_ENDSTOPS))	/*--mks cfg--*/
