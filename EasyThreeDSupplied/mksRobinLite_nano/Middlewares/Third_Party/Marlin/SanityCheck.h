 ...
 */
 #if 0	//mks_delta
#if ENABLED(DELTA)
  //#if DISABLED(USE_XMAX_PLUG) && DISABLED(USE_YMAX_PLUG) && DISABLED(USE_ZMAX_PLUG)   //mks
#if !defined(USE_XMAX_PLUG) && !defined(USE_YMAX_PLUG) && !defined(USE_ZMAX_PLUG)
...
//#if ENABLED(PIDTEMPBED) && ENABLED(BED_LIMIT_SWITCHING)	/*--mks cfg--*/
#if 0
 ...
 */
#if 0     /*--mks cfg-- AUTO_BED_LEVELING_BILINEAR */
static_assert(1 >= 0
 ...
 * Mesh Bed Leveling
 */
#if 0 /*--mks cfg-- MESH_BED_LEVELING */
#if ENABLED(MESH_BED_LEVELING)
  #if ENABLED(DELTA)
...
static_assert(1 >= 0
   ...
   */
  #if ENABLED(Z_PROBE_SLED) && defined(DELTA)
   ...
   */
    ...
    //#elif DISABLED(USE_ZMIN_PLUG)
      #elif !defined(USE_ZMIN_PLUG)
      #error "Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN requires USE_ZMIN_PLUG to be enabled."
    #elif !HAS_Z_MIN
      #error "Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN requires the Z_MIN_PIN to be defined."
	  /*--mks cfg -- Z_MIN_ENDSTOP_INVERTING */
...
/*--mks cfg-- AUTO_BED_LEVELING_BILINEAR */
   ...
   */
	...
	/*
      ...
      #endif*/
/*--mks cfg-- AUTO_BED_LEVELING_ LINEAR */
/*
...
/*--mks cfg-- AUTO_BED_LEVELING_ UBL */
...
*/
  ...
  /*--mks cfg-- AUTO_BED_LEVELING_3POINT */
  /*
 ...
 * Endstops
 */
#if !defined(USE_XMIN_PLUG) && !defined(USE_XMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _XMAX_, _XMIN_))
 #error "You must enable USE_XMIN_PLUG or USE_XMAX_PLUG."
#elif !defined(USE_YMIN_PLUG) && !defined(USE_YMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _YMAX_, _YMIN_))
 #error "You must enable USE_YMIN_PLUG or USE_YMAX_PLUG."
#elif !defined(USE_ZMIN_PLUG) && !defined(USE_ZMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _ZMAX_, _ZMIN_))
 ...
 */
/*--mks--*/
const float sanity_arr_1[] = DEFAULT_AXIS_STEPS_PER_UNIT,
