 ...
 */
   ...
   */
        ...
        #define SHORT_BUILD_VERSION " "//mks
	#define SHORT_LITE_VERSION "0.0.4" 
	//#define SHORT_WIFI_VERSION "1.0.0"
  ...
  #define WEBSITE_URL " "//mks
  //#define WEBSITE_URL "Run To A Better 3D Word"//R3D
