...
/*
 * mks stm32 Board pin           |  PORT  | Label
 * ---------------------------------+--------+-------
 *   0                              |  PA10  | "RX0",pwm
 *   1                              |  PA9   | "TX0",pwm
 *   2                              |  PD10  |
...
extern const PinDescription g_APinDescription[]=
{
  ...
  // 13 - AMBER LED
  { GPIOE, GPIO_Pin_1,   RCC_APB2Periph_GPIOE, NONE, NULL, NONE}, //  skyblue modify
   //{ GPIOF, GPIO_Pin_6,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  //{ GPIOC, GPIO_Pin_13,   RCC_APB2Periph_GPIOC, NONE, NULL, NONE},
  //{ GPIOF, GPIO_Pin_11,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},  
  //{ GPIOG, GPIO_Pin_15,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},  
  ...
  // 70 SDA1,71 SCL1
  { GPIOB, GPIO_Pin_11,  RCC_APB2Periph_GPIOB, NONE, NULL, NONE }, // PIN 41	TIM2_CH4,PWM
  { GPIOB, GPIO_Pin_10,  RCC_APB2Periph_GPIOB, NONE, NULL, NONE }, // PIN 42	TIM2_CH3,PWM
  ...
  //75
  { GPIOF, GPIO_Pin_6,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  { GPIOF, GPIO_Pin_8,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  { GPIOF, GPIO_Pin_9,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  { GPIOF, GPIO_Pin_11,   RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  { GPIOG, GPIO_Pin_8,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  //80
  { GPIOG, GPIO_Pin_10,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  { GPIOG, GPIO_Pin_13,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  { GPIOG, GPIO_Pin_14,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  { GPIOG, GPIO_Pin_15,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  { GPIOF, GPIO_Pin_7,    RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  //85
  { GPIOG, GPIO_Pin_9,   RCC_APB2Periph_GPIOG, NONE, NULL, NONE},
  { GPIOF, GPIO_Pin_10,    RCC_APB2Periph_GPIOF, NONE, NULL, NONE},
  //87(USART3_TX remap),19(USART3_RX remap)
  { GPIOB, GPIO_Pin_10,   RCC_APB2Periph_GPIOB, NONE, NULL, NONE }, // PIN 36
  { GPIOB, GPIO_Pin_11,   RCC_APB2Periph_GPIOB, NONE, NULL, NONE }, // PIN 35  
...
//void serialEvent() __attribute__((weak));       //skyblue mask
void serialEvent() { }
//USARTClass Serial1(UART4, UART4_IRQn, id_serial1, &rx_buffer2); //skyblue mask
//void serialEvent1() __attribute__((weak));    //skyblue mask
void serialEvent1() { }
USARTClass Serial2(USART2, USART2_IRQn, id_serial2, &rx_buffer3);
//void serialEvent2() __attribute__((weak));    //skyblue mask
void serialEvent2() { }
USARTClass Serial3(USART3, USART3_IRQn, id_serial3, &rx_buffer4);
//void serialEvent3() __attribute__((weak));    //skyblue mask
void serialEvent3() { }
...
void USART1_IRQHandler(void) 
{
 // digitalWrite(13,!digitalRead(13));
  //Serial1IrqHandler();//USART1 must be Serial,for usart flash programming.
