      ...
      if (FLASH_WaitForLastOperation((uint32_t)((uint32_t)50000)) == HAL_OK)
      {
        ...
        *PageError = 0xFFFFFFFF;
        ...
        for(address = pEraseInit->PageAddress;
            address < ((pEraseInit->NbPages * ((uint32_t)0x800)) + pEraseInit->PageAddress);
            address += ((uint32_t)0x800))
        {
...
uint32_t HAL_FLASHEx_OBGetUserData(uint32_t DATAAdress)
{
  ...
  if (DATAAdress == ((uint32_t)0x1FFFF804))
  {
    ...
    value = ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR) & ((0xFFU << (10U)))) >> (uint32_t)(__CLZ(__iar_builtin_RBIT((0xFFU << (10U)))));
  }
  else
  {
     
    value = ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR) & ((0xFFU << (18U)))) >> (uint32_t)(__CLZ(__iar_builtin_RBIT((0xFFU << (18U)))));
  }
...
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WriteProtectPage)
{
  ...
  WRP1_Data = (uint16_t)((WriteProtectPage & ((uint32_t)0x0000FF00)) >> 8);
 
  WRP2_Data = (uint16_t)((WriteProtectPage & ((uint32_t)0x00FF0000)) >> 16);

  WRP3_Data = (uint16_t)((WriteProtectPage & ((uint32_t)0xFF000000)) >> 24); 
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR)) & (0x7U << (2U))) >> (uint32_t)(__CLZ(__iar_builtin_RBIT((0x1U << (2U))))));
}
