...
{
  font += offset;
  return (*(const u8g_pgm_uint8_t *)((u8g_pgm_uint8_t *)font));  
}
...
static uint16_t u8g_font_get_word(const u8g_fntpgm_uint8_t *font, uint8_t offset)
{
    uint16_t pos;
    font += offset;
    pos = (*(const u8g_pgm_uint8_t *)((u8g_pgm_uint8_t *)font));
    font++;
    pos <<= 8;
    pos += (*(const u8g_pgm_uint8_t *)((u8g_pgm_uint8_t *)font));
    return pos;
...
size_t u8g_font_GetSize(const void *font)
{
  ...
  for(;;)
  {
    if ( (*(const u8g_pgm_uint8_t *)((u8g_pgm_uint8_t *)(p))) == 255 )
    {
      p += 1;
    }
    else
    {
      p += (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)(p)) + 2)) & mask;
...
static void u8g_CopyGlyphDataToCache(u8g_t *u8g, u8g_glyph_t g)
{
  ...
  switch( u8g_font_GetFormat(u8g->font) )
  {
    ...
    case 2:
      ...
      u8g->glyph_width =  (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 0));
      u8g->glyph_height =  (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 1));
      u8g->glyph_dx =  (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 3));
      u8g->glyph_x =  (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 4));
      u8g->glyph_y =  (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 5));
      break;
    case 1:
    default:
      ...
      tmp = (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 0));
      u8g->glyph_y =  tmp & 15;
      u8g->glyph_y-=2;
      tmp >>= 4;
      u8g->glyph_x =  tmp;
    
      tmp = (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 1));
      u8g->glyph_height =  tmp & 15;
      tmp >>= 4;
      u8g->glyph_width =  tmp;
      
      tmp = (*(const u8g_pgm_uint8_t *)(((u8g_pgm_uint8_t *)g) + 2));
      tmp >>= 4;
      u8g->glyph_dx = tmp;
...
uint8_t u8g_IsGlyph(u8g_t *u8g, uint8_t requested_encoding)
{
  if ( u8g_GetGlyph(u8g, requested_encoding) != 0 )
    return 1;
  return 0;
}
...
int8_t u8g_draw_glyph(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, uint8_t encoding)
{
  ...
  for( j = 0; j < h; j++ )
  {
    ...
    for( i = 0; i < w; i++ )
    {
      u8g_Draw8Pixel(u8g, ix, iy, 0, (*(const u8g_pgm_uint8_t *)(data)));
      data++;
      ix+=8;
    }
    iy++;
...
int8_t u8g_draw_glyph90(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, uint8_t encoding)
{
  ...
  for( j = 0; j < h; j++ )
  {
    ...
    for( i = 0; i < w; i++ )
    {
      u8g_Draw8Pixel(u8g, ix, iy, 1, (*(const u8g_pgm_uint8_t *)(data)));
      data++;
      iy+=8;
    }
    ix--;
...
int8_t u8g_draw_glyph180(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, uint8_t encoding)
{
  ...
  for( j = 0; j < h; j++ )
  {
    ...
    for( i = 0; i < w; i++ )
    {
      u8g_Draw8Pixel(u8g, ix, iy, 2, (*(const u8g_pgm_uint8_t *)(data)));
      data++;
      ix-=8;
    }
    iy--;
...
int8_t u8g_draw_glyph270(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, uint8_t encoding)
{
  ...
  for( j = 0; j < h; j++ )
  {
    ...
    for( i = 0; i < w; i++ )
    {
      u8g_Draw8Pixel(u8g, ix, iy, 3, (*(const u8g_pgm_uint8_t *)(data)));
      data++;
      iy-=8;
    }
    ix++;
...
u8g_uint_t u8g_DrawStr90P(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, const u8g_pgm_uint8_t *s)
{
  ...
  while( *s != '\0' )
  {
    d = u8g_DrawGlyph90(u8g, x, y, (*(const u8g_pgm_uint8_t *)(s)));
    y += d;
    t += d;
    s++;
  }
...
u8g_uint_t u8g_DrawStr180P(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, const u8g_pgm_uint8_t *s)
{
  ...
  while( *s != '\0' )
  {
    d = u8g_DrawGlyph180(u8g, x, y, (*(const u8g_pgm_uint8_t *)(s)));
    x -= d;
    t += d;
    s++;
  }
...
u8g_uint_t u8g_DrawStr270P(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, const u8g_pgm_uint8_t *s)
{
  ...
  while( *s != '\0' )
  {
    d = u8g_DrawGlyph270(u8g, x, y, (*(const u8g_pgm_uint8_t *)(s)));
    y -= d;
    t += d;
    s++;
  }
...
void u8g_SetFontRefHeightText(u8g_t *u8g)
{
  u8g->font_height_mode = 0;
  u8g_UpdateRefHeight(u8g);
}

void u8g_SetFontRefHeightExtendedText(u8g_t *u8g)
{
  u8g->font_height_mode = 1;
  u8g_UpdateRefHeight(u8g);
}
...
{
  return (*(const u8g_pgm_uint8_t *)(s));
}
...
int8_t u8g_GetStrXP(u8g_t *u8g, const u8g_pgm_uint8_t *s)
{
  u8g_GetGlyph(u8g, (*(const u8g_pgm_uint8_t *)(s)));
  return u8g->glyph_x;  
}
...
u8g_uint_t u8g_GetStrWidthP(u8g_t *u8g, const u8g_pgm_uint8_t *s)
{
  ...
  for(;;)
  {
    encoding = (*(const u8g_pgm_uint8_t *)(s));
    if ( encoding == 0 )
      break;
...
int8_t u8g_draw_aa_glyph(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, uint8_t encoding)
{
  ...
  for( j = 0; j < h; j++ )
  {
    ...
    for( i = 0; i < w; i++ )
    {
      u8g_Draw4TPixel(u8g, ix, iy, 0, (*(const u8g_pgm_uint8_t *)(data)));
      data++;
      ix+=4;
    }
    iy++;
