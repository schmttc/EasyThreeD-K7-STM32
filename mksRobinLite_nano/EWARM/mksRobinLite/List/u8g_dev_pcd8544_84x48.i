...
static const uint8_t u8g_dev_pcd8544_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((1)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
...
static const uint8_t u8g_dev_pcd8544_sleep_on[]  = {
  255, (0xe0 | ((0)&0x0f)),           	 
  255, (0xd0 | ((1)&0x0f)),             	 
...
static const uint8_t u8g_dev_pcd8544_sleep_off[]  = {
  255, (0xe0 | ((0)&0x0f)),           	 
  255, (0xd0 | ((1)&0x0f)),             	 
  0x020,		                 
  0x008,		                 
    ...
    case 21:
      {
        ...
        u8g_WriteByte(u8g, dev, 0x020 );		 
        u8g_WriteByte(u8g, dev, 0x080 );                         
        u8g_WriteByte(u8g, dev, 0x040 | pb->p.page);  
...
uint8_t u8g_dev_pcd8544_84x48_sw_spi_buf[84]  ; u8g_pb_t u8g_dev_pcd8544_84x48_sw_spi_pb = { {8, 48, 0, 0, 0}, 84, u8g_dev_pcd8544_84x48_sw_spi_buf}; u8g_dev_t u8g_dev_pcd8544_84x48_sw_spi = { u8g_dev_pcd8544_fn, &u8g_dev_pcd8544_84x48_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_pcd8544_84x48_hw_spi_buf[84]  ; u8g_pb_t u8g_dev_pcd8544_84x48_hw_spi_pb = { {8, 48, 0, 0, 0}, 84, u8g_dev_pcd8544_84x48_hw_spi_buf}; u8g_dev_t u8g_dev_pcd8544_84x48_hw_spi = { u8g_dev_pcd8544_fn, &u8g_dev_pcd8544_84x48_hw_spi_pb, u8g_com_null_fn };
