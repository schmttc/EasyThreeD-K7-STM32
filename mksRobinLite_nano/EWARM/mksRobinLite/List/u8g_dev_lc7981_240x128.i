...
static const uint8_t u8g_dev_lc7981_240x128_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((1)&0x0f)),            
  255, (0xc0 | ((15)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
    ...
    case 21:
      {
        ...
        {
          u8g_SetAddress(u8g, dev, 1);            
          u8g_WriteByte(u8g, dev, 0x00a );       
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteByte(u8g, dev, disp_ram_adr & 0x0ff );  

          u8g_SetAddress(u8g, dev, 1);            
          u8g_WriteByte(u8g, dev, 0x00b );       
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteByte(u8g, dev, disp_ram_adr >> 8 );  
          
          u8g_SetAddress(u8g, dev, 1);            
          u8g_WriteByte(u8g, dev, 0x00c );       
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteSequence(u8g, dev, 240/8, ptr);
          ptr += 240/8;
          disp_ram_adr += 240/8;
        }
...
uint8_t u8g_dev_lc7981_240x128_8bit_buf[240]  ; u8g_pb_t u8g_dev_lc7981_240x128_8bit_pb = { {8, 128, 0, 0, 0}, 240, u8g_dev_lc7981_240x128_8bit_buf}; u8g_dev_t u8g_dev_lc7981_240x128_8bit = { u8g_dev_lc7981_240x128_fn, &u8g_dev_lc7981_240x128_8bit_pb, u8g_com_null_fn };
