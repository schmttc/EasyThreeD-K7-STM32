...
static const uint8_t u8g_dev_ssd1306_128x32_adafruit1_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),         
  255, (0xe0 | ((0)&0x0f)),        
  255, (0xc0 | ((1)&0x0f)),        
  255, (0xd0 | ((1)&0x0f)),         
...
static const uint8_t u8g_dev_ssd1306_128x32_adafruit2_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),         
  255, (0xe0 | ((0)&0x0f)),        
  255, (0xc0 | ((1)&0x0f)),        
  255, (0xd0 | ((1)&0x0f)),         
...
static const uint8_t u8g_dev_ssd1306_128x32_adafruit3_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),         
  255, (0xe0 | ((0)&0x0f)),        
  255, (0xc0 | ((1)&0x0f)),		 
  255, (0xd0 | ((1)&0x0f)),         
...
static const uint8_t u8g_dev_ssd1306_128x32_data_start[]  = {
  255, (0xe0 | ((0)&0x0f)),        
  255, (0xd0 | ((1)&0x0f)),         
  0x010,				 
  0x000,				 
...
uint8_t u8g_dev_ssd1306_128x32_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
    case 10:
      ...
      u8g_WriteEscSeqP(u8g, dev, u8g_dev_ssd1306_128x32_adafruit3_init_seq);
      break;
    case 11:
      break;
    case 21:
...
uint8_t u8g_dev_ssd1306_128x32_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x32_sw_spi_pb = { {8, 32, 0, 0, 0}, 128, u8g_dev_ssd1306_128x32_sw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_128x32_sw_spi = { u8g_dev_ssd1306_128x32_fn, &u8g_dev_ssd1306_128x32_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_128x32_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x32_hw_spi_pb = { {8, 32, 0, 0, 0}, 128, u8g_dev_ssd1306_128x32_hw_spi_buf}; u8g_dev_t u8g_dev_ssd1306_128x32_hw_spi = { u8g_dev_ssd1306_128x32_fn, &u8g_dev_ssd1306_128x32_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1306_128x32_i2c_buf[128]  ; u8g_pb_t u8g_dev_ssd1306_128x32_i2c_pb = { {8, 32, 0, 0, 0}, 128, u8g_dev_ssd1306_128x32_i2c_buf}; u8g_dev_t u8g_dev_ssd1306_128x32_i2c = { u8g_dev_ssd1306_128x32_fn, &u8g_dev_ssd1306_128x32_i2c_pb, u8g_com_null_fn };

uint8_t u8g_dev_ssd1306_128x32_2x_buf[128*2]  ; 
u8g_pb_t u8g_dev_ssd1306_128x32_2x_pb = { {16, 32, 0, 0, 0},  128, u8g_dev_ssd1306_128x32_2x_buf}; 
u8g_dev_t u8g_dev_ssd1306_128x32_2x_sw_spi = { u8g_dev_ssd1306_128x32_2x_fn, &u8g_dev_ssd1306_128x32_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1306_128x32_2x_hw_spi = { u8g_dev_ssd1306_128x32_2x_fn, &u8g_dev_ssd1306_128x32_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1306_128x32_2x_i2c = { u8g_dev_ssd1306_128x32_2x_fn, &u8g_dev_ssd1306_128x32_2x_pb, u8g_com_null_fn };
