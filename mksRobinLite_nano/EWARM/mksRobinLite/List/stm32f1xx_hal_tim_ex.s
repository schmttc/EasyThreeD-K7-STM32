...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\stm32f1xx_hal_tim_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
// 1488       (InputTrigger == TIM_TS_ITR2) || (InputTrigger == TIM_TS_ITR3))
        CMP      R1,#+0
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_0
        CMP      R1,#+16
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_0
        CMP      R1,#+32
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_0
        CMP      R1,#+48
        BNE.N    ??HAL_TIMEx_ConfigCommutationEvent_1
// 1489   {
...
// 1537       (InputTrigger == TIM_TS_ITR2) || (InputTrigger == TIM_TS_ITR3))
        CMP      R1,#+0
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_IT_0
        CMP      R1,#+16
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_IT_0
        CMP      R1,#+32
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_IT_0
        CMP      R1,#+48
        BNE.N    ??HAL_TIMEx_ConfigCommutationEvent_IT_1
// 1538   {
...
// 1590       (InputTrigger == TIM_TS_ITR2) || (InputTrigger == TIM_TS_ITR3))
        CMP      R1,#+0
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_DMA_0
        CMP      R1,#+16
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_DMA_0
        CMP      R1,#+32
        BEQ.N    ??HAL_TIMEx_ConfigCommutationEvent_DMA_0
        CMP      R1,#+48
        BNE.N    ??HAL_TIMEx_ConfigCommutationEvent_DMA_1
// 1591   {
