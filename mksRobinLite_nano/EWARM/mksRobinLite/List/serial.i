...
void serial_echopair_P(const char* s_P, const char *v)   { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, char v)          { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . write(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, int v)           { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, long v)          { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, float v)         { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, double v)        { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }
void serial_echopair_P(const char* s_P, unsigned long v) { serialprintPGM(s_P); {if(!from_wifi_flag){customizedSerial . print(v);}else{serial2 . print(v);}}; }

void serial_spaces(uint8_t count) { while (count--) customizedSerial .write(' '); }
