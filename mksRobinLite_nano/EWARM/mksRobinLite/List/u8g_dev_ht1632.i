...
uint8_t u8g_dev_ht1632_24x16_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	ht1632_transfer_data(u8g, pb->p.page, 24, pb->buf);
      }
      break;
    case 15:
...
uint8_t u8g_dev_ht1632_24x16_buf[24*2]  ; 
u8g_pb_t u8g_dev_ht1632_24x16_pb = { {16, 16, 0, 0, 0},  24, u8g_dev_ht1632_24x16_buf}; 
