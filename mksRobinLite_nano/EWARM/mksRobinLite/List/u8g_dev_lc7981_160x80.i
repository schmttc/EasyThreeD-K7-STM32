...
static const uint8_t u8g_dev_lc7981_160x80_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((1)&0x0f)),            
  255, (0xc0 | ((15)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
    ...
    case 21:
      {
        ...
        for( i = 0; i < 8; i ++ )
        {
          ...
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteSequence(u8g, dev, 160/8, ptr);
          ptr += 160/8;
          disp_ram_adr += 160/8;
        }
...
uint8_t u8g_dev_lc7981_160x80_8bit_buf[160]  ; u8g_pb_t u8g_dev_lc7981_160x80_8bit_pb = { {8, 80, 0, 0, 0}, 160, u8g_dev_lc7981_160x80_8bit_buf}; u8g_dev_t u8g_dev_lc7981_160x80_8bit = { u8g_dev_lc7981_160x80_fn, &u8g_dev_lc7981_160x80_8bit_pb, u8g_com_null_fn };
