...
void safe_delay(millis_t ms) {
  ...
  char* itostr3(const int& x) {
    int xx = x;
    conv[4] = (xx >= 0 ? (((xx) >= (100) ? ('0' + ((xx)/(100) % 10)) : ' ')) : (xx = -xx, '-'));
    conv[5] = ((xx) >= (10) ? ('0' + ((xx)/(10) % 10)) : ' ');
    conv[6] = ('0' + ((xx)/(1) % 10));
    return &conv[4];
  }
  ...
  char *ftostr32(const float& x) {
    long xx = x * 100;
    conv[1] = (xx >= 0 ? (('0' + ((xx)/(10000) % 10))) : (xx = -xx, '-'));
    conv[2] = ('0' + ((xx)/(1000) % 10));
    conv[3] = ('0' + ((xx)/(100) % 10));
    conv[4] = '.';
    conv[5] = ('0' + ((xx)/(10) % 10));
  ...
  char* ftostr5rj(const float& x) {
    ...
    conv[2] = ((xx) >= (10000) ? ('0' + ((xx)/(10000) % 10)) : ' ');
    conv[3] = ((xx) >= (1000) ? ('0' + ((xx)/(1000) % 10)) : ' ');
    conv[4] = ((xx) >= (100) ? ('0' + ((xx)/(100) % 10)) : ' ');
    conv[5] = ((xx) >= (10) ? ('0' + ((xx)/(10) % 10)) : ' ');
    conv[6] = ('0' + ((xx)/(1) % 10));
    return &conv[2];
  }
  ...
  char* ftostr62rj(const float& x) {
    const long xx = (x < 0 ? -x : x) * 100;
    conv[0] = ((xx) >= (100000) ? ('0' + ((xx)/(100000) % 10)) : ' ');
    conv[1] = ((xx) >= (10000) ? ('0' + ((xx)/(10000) % 10)) : ' ');
    conv[2] = ((xx) >= (1000) ? ('0' + ((xx)/(1000) % 10)) : ' ');
    conv[3] = ('0' + ((xx)/(100) % 10));
    conv[4] = '.';
    conv[5] = ('0' + ((xx)/(10) % 10));
    conv[6] = ('0' + ((xx)/(1) % 10));
  ...
  char* ftostr52sp(const float& x) {
    long xx = x * 100;
    uint8_t dig;
    conv[1] = (xx >= 0 ? (((xx) >= (10000) ? ('0' + ((xx)/(10000) % 10)) : ' ')) : (xx = -xx, '-'));
    conv[2] = ((xx) >= (1000) ? ('0' + ((xx)/(1000) % 10)) : ' ');
    conv[3] = ('0' + ((xx)/(100) % 10));
