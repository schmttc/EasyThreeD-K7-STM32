...
static const uint8_t u8g_dev_t6963_240x128_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((15)&0x0f)),            
...
uint8_t u8g_dev_t6963_240x128_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	u8g_SetAddress(u8g, dev, 0);            
        ...
        {
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteByte(u8g, dev, disp_ram_adr&255 );       
          u8g_WriteByte(u8g, dev, disp_ram_adr>>8 );       
          u8g_SetAddress(u8g, dev, 1);            
          u8g_WriteByte(u8g, dev, 0x024 );       
...
uint8_t u8g_dev_t6963_240x128_2x_bw_buf[240/8*16]  ; 
u8g_pb_t u8g_dev_t6963_240x128_2x_bw_pb = { {16, 128, 0, 0, 0},  240, u8g_dev_t6963_240x128_2x_bw_buf}; 
u8g_dev_t u8g_dev_t6963_240x128_8bit = { u8g_dev_t6963_240x128_fn, &u8g_dev_t6963_240x128_2x_bw_pb, u8g_com_null_fn };
