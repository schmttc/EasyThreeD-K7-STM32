...
uint8_t u8g_InitLL(u8g_t *u8g, u8g_dev_t *dev)
{
  uint8_t r;
  u8g->state_cb((((1)<<1) | (0)));
  r =  u8g_call_dev_fn(u8g, dev, 10, 0);
  u8g->state_cb((((1)<<1) | (1)));
  u8g->state_cb((((0)<<1) | (0)));
  return r;
}
...
{  
  u8g->state_cb((((1)<<1) | (0)));
  u8g->state_cb((((0)<<1) | (1)));
  u8g_call_dev_fn(u8g, dev, 20, 0);
  u8g_call_dev_fn(u8g, dev, 23, &(u8g->current_page));
  u8g->state_cb((((0)<<1) | (0)));
}
...
{  
  ...
  u8g->state_cb((((1)<<1) | (0)));
  u8g->state_cb((((0)<<1) | (1)));
  r = u8g_call_dev_fn(u8g, dev, 21, 0);
  if ( r != 0 )
  {
    u8g_call_dev_fn(u8g, dev, 23, &(u8g->current_page));
  }
...
uint8_t u8g_SetContrastLL(u8g_t *u8g, u8g_dev_t *dev, uint8_t contrast)
{  
  return u8g_call_dev_fn(u8g, dev, 15, &contrast);
}
...
void u8g_DrawPixelLL(u8g_t *u8g, u8g_dev_t *dev, u8g_uint_t x, u8g_uint_t y)
{
  ...
  arg->x = x;
  arg->y = y;
  u8g_call_dev_fn(u8g, dev, 50, arg);
}
...
void u8g_Draw8PixelLL(u8g_t *u8g, u8g_dev_t *dev, u8g_uint_t x, u8g_uint_t y, uint8_t dir, uint8_t pixel)
{
  ...
  arg->dir = dir;
  arg->pixel = pixel;
  u8g_call_dev_fn(u8g, dev, 59, arg);
}
...
void u8g_Draw4TPixelLL(u8g_t *u8g, u8g_dev_t *dev, u8g_uint_t x, u8g_uint_t y, uint8_t dir, uint8_t pixel)
{
  ...
  arg->dir = dir;
  arg->pixel = pixel;
  u8g_call_dev_fn(u8g, dev, 45, arg);
}
...
{       
  u8g_uint_t r;
  u8g_call_dev_fn(u8g, dev, 71, &r);
  return r;
}

u8g_uint_t u8g_GetModeLL(u8g_t *u8g, u8g_dev_t *dev)
{       
  return u8g_call_dev_fn(u8g, dev, 72, 0);
}
...
void u8g_UpdateDimension(u8g_t *u8g)
{
  ...
  u8g_call_dev_fn(u8g, u8g->dev, 23, &(u8g->current_page));
}
...
uint8_t u8g_Init(u8g_t *u8g, u8g_dev_t *dev)
{
  ...
  if(!lcd_hal_delay_enable) return 0;
...
void u8g_SleepOn(u8g_t *u8g)
{
  u8g_call_dev_fn(u8g, u8g->dev, 16, 0);
}

void u8g_SleepOff(u8g_t *u8g)
{
  u8g_call_dev_fn(u8g, u8g->dev, 17, 0);
}
...
void u8g_SetColorEntry(u8g_t *u8g, uint8_t idx, uint8_t r, uint8_t g, uint8_t b)
{
  ...
  irgb.g = g;
  irgb.b = b;  
  u8g_call_dev_fn(u8g, u8g->dev, 60, &irgb);
}
