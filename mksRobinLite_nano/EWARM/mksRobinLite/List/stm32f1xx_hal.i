...
__weak void HAL_SetTick(uint32_t setTick)
{
   uwTick = setTick;
}
...
void HAL_Delay_us(volatile uint32_t nTime)
{
    volatile int old_val,new_val,val;
    ...
    old_val = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
    new_val = old_val - 72*nTime;
    if(new_val >= 0)
    {
        do
        {
            val = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
        }
...
uint32_t HAL_GetREVID(void)
{
  return((((DBGMCU_TypeDef *) ((uint32_t)0xE0042000))->IDCODE) >> (__CLZ(__iar_builtin_RBIT((0xFFFFU << (16U))))));
}
