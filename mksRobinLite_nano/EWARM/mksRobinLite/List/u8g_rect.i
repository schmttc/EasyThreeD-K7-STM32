...
void u8g_DrawRFrame(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, u8g_uint_t w, u8g_uint_t h, u8g_uint_t r)
{
 ...
 
  {
    ...
    u8g_draw_circle(u8g, xl, yu, r, 0x02);
    u8g_draw_circle(u8g, xr, yu, r, 0x01);
    u8g_draw_circle(u8g, xl, yl, r, 0x04);
    u8g_draw_circle(u8g, xr, yl, r, 0x08);
  }
...
void u8g_DrawRBox(u8g_t *u8g, u8g_uint_t x, u8g_uint_t y, u8g_uint_t w, u8g_uint_t h, u8g_uint_t r)
{
  ...
  u8g_draw_disc(u8g, xl, yu, r, 0x02);
  u8g_draw_disc(u8g, xr, yu, r, 0x01);
  u8g_draw_disc(u8g, xl, yl, r, 0x04);
  u8g_draw_disc(u8g, xr, yl, r, 0x08);
