...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  if ((((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001)))
  {
    ...
    if((temp_reg != 0x00000000U) && (temp_reg != (PeriphClkInit->RTCClockSelection & (0x3U << (8U)))))
    {
      ...
      (*(volatile uint32_t *) ((uint32_t)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x20000) + 0x1000) - ((uint32_t)0x40000000)) + 0x20) * 32) + ((__CLZ(__iar_builtin_RBIT((0x1U << (16U))))) * 4))) = ENABLE);
      (*(volatile uint32_t *) ((uint32_t)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x20000) + 0x1000) - ((uint32_t)0x40000000)) + 0x20) * 32) + ((__CLZ(__iar_builtin_RBIT((0x1U << (16U))))) * 4))) = DISABLE);
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection |= ((uint32_t)0x00000004);
  PeriphClkInit->I2s2ClockSelection = ((uint32_t)0x00000000);

   
  PeriphClkInit->PeriphClockSelection |= ((uint32_t)0x00000008);
  PeriphClkInit->I2s3ClockSelection = ((uint32_t)0x00000000);
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
  ...
  case ((uint32_t)0x00000010):  
    {
      ...
      {
        pllmul = aPLLMULFactorTable[(uint32_t)(temp_reg & (0xFU << (18U))) >> (__CLZ(__iar_builtin_RBIT((0xFU << (18U)))))];
        if ((temp_reg & (0x1U << (16U))) != ((uint32_t)0x00000000))
        {
          prediv1 = aPredivFactorTable[(uint32_t)(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & (0x1U << (17U))) >> (__CLZ(__iar_builtin_RBIT((0x1U << (17U)))))];
  ...
  case ((uint32_t)0x00000002):  
    {
      frequency = HAL_RCC_GetPCLK2Freq() / (((((uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR) & ((0x3U << (14U)))))) >> (__CLZ(__iar_builtin_RBIT(((uint32_t)0x00004000))))) + 1) * 2);
      break;
    }
  default: 
    {
