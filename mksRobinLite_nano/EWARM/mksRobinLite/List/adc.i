...
uint16_t uhADCxConvertedValue_temp[2];
...
void MX_ADC1_Init(void)
{
  ...
  hadc1.Instance = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400));
  hadc1.Init.ScanConvMode = ((uint32_t)(0x1U << (8U)));
  hadc1.Init.ContinuousConvMode = ENABLE;
  hadc1.Init.DiscontinuousConvMode = DISABLE;
  hadc1.Init.ExternalTrigConv = ((uint32_t)((0x4U << (17U)) | (0x2U << (17U)) | (0x1U << (17U))));
  hadc1.Init.DataAlign = ((uint32_t)0x00000000);
  ...
  sConfig.Channel = ((uint32_t)0x00000000);
  sConfig.Rank = 1;
  ...
  sConfig.Channel = ((uint32_t)( (0x01U << (0U))));
  sConfig.Rank = 2;
  if (HAL_ADC_ConfigChannel(&hadc1, &sConfig) != HAL_OK)
  {
    Error_Handler();
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  if(adcHandle->Instance==((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= ((0x1U << (9U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) & ((0x1U << (9U)))); ((void)(tmpreg)); } while(0);
    ...
    hdma_adc1.Instance = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008));
    hdma_adc1.Init.Direction = ((uint32_t)0x00000000);
    hdma_adc1.Init.PeriphInc = ((uint32_t)0x00000000);
    hdma_adc1.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    hdma_adc1.Init.PeriphDataAlignment = ((uint32_t)(0x1U << (8U)));
    hdma_adc1.Init.MemDataAlignment = ((uint32_t)(0x1U << (10U)));
    hdma_adc1.Init.Mode = ((uint32_t)(0x1U << (5U)));
    hdma_adc1.Init.Priority = ((uint32_t)0x00000000);
    if (HAL_DMA_Init(&hdma_adc1) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (adcHandle)->DMA_Handle = &(hdma_adc1); (hdma_adc1). Parent = (adcHandle); } while(0);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  if(adcHandle->Instance==((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR &= ~((0x1U << (9U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001)|((uint16_t)0x0002));
