...
extern void IsrStepperHandler(void);
extern void IsrTemperatureHandler(void);
extern void TimerStService(void);
...
unsigned long timer2Cnt=0;
unsigned long timer4Cnt=0;
...
void USART1_IRQHandler(void)
{
  ...
  HAL_UART_IRQHandler(customizedSerial.getUartStack()->pUart);
...
void USART2_IRQHandler(void)
{
  ...
  HAL_UART_IRQHandler(serial2.getUartStack()->pUart);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0800), GPIO_PIN_SET);
