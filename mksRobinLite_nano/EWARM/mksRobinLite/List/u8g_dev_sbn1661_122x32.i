...
static const uint8_t u8g_dev_sbn1661_122x32_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((15)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
    ...
    case 21:
      {
        ...
        u8g_WriteSequence(u8g, dev, 122/2, pb->buf);
        ...
        u8g_WriteByte(u8g, dev, 0x000 );  
        u8g_SetAddress(u8g, dev, 1);            
        u8g_WriteSequence(u8g, dev, 122/2, 122/2+(uint8_t *)pb->buf);
...
uint8_t u8g_dev_sbn1661_122x32_buf[122]  ; u8g_pb_t u8g_dev_sbn1661_122x32_pb = { {8, 32, 0, 0, 0}, 122, u8g_dev_sbn1661_122x32_buf}; u8g_dev_t u8g_dev_sbn1661_122x32 = { u8g_dev_sbn1661_122x32_fn, &u8g_dev_sbn1661_122x32_pb, u8g_com_arduino_no_en_parallel_fn };
