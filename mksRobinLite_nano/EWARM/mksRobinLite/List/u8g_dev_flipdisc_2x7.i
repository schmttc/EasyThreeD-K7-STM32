...
uint8_t u8g_dev_flipdisc_2x7_bw_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	(*u8g_write_flip_disc_matrix)(0, pb->p.page, 28, pb->buf, (uint8_t *)(pb->buf)+28);
      }
      break;
    case 15:
      return 1;
...
uint8_t u8g_dev_flipdisc_2x7_bw_buf[28*2]  ; 
u8g_pb_t u8g_dev_flipdisc_2x7_bw_pb = { {16, 14, 0, 0, 0},  28, u8g_dev_flipdisc_2x7_bw_buf}; 
