...
static const uint8_t u8g_dev_ssd1325_2bit_nhd_27_12864ucy3_init_seq[]  = {
  255, ((10) & 0x7f),               
  255, (0xd0 | ((0)&0x0f)),                  
  255, (0xe0 | ((0)&0x0f)),                
  255, (0xc0 | ((1)&0x0f)),                
  ...
  0x0b8,                                 
      ...
      0x01, 0x011, 0x022, 0x032, 0x043, 0x054, 0x077, 0x077,            
  0x081, 0x070,                     
  0x0b2, 0x051,                     
  0x0b1, 0x055,                     
  0x0bc, 0x010,                     
...
static uint8_t u8g_dev_ssd1325_nhd27oled_gr_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	{
	  u8g_dev_ssd1325_gr_prepare_row(u8g, dev, i);		 
...
uint8_t u8g_dev_ssd1325_nhd27oled_gr_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1325_nhd27oled_gr_sw_spi_pb = { {4, 64, 0, 0, 0}, 128, u8g_dev_ssd1325_nhd27oled_gr_sw_spi_buf}; u8g_dev_t u8g_dev_ssd1325_nhd27oled_gr_sw_spi = { u8g_dev_ssd1325_nhd27oled_gr_fn, &u8g_dev_ssd1325_nhd27oled_gr_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1325_nhd27oled_gr_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1325_nhd27oled_gr_hw_spi_pb = { {4, 64, 0, 0, 0}, 128, u8g_dev_ssd1325_nhd27oled_gr_hw_spi_buf}; u8g_dev_t u8g_dev_ssd1325_nhd27oled_gr_hw_spi = { u8g_dev_ssd1325_nhd27oled_gr_fn, &u8g_dev_ssd1325_nhd27oled_gr_hw_spi_pb, u8g_com_null_fn };

uint8_t u8g_dev_ssd1325_nhd27oled_2x_buf[128*2]  ; 
u8g_pb_t u8g_dev_ssd1325_nhd27oled_2x_pb = { {8, 64, 0, 0, 0},  128, u8g_dev_ssd1325_nhd27oled_2x_buf}; 
u8g_dev_t u8g_dev_ssd1325_nhd27oled_2x_gr_sw_spi = { u8g_dev_ssd1325_nhd27oled_2x_gr_fn, &u8g_dev_ssd1325_nhd27oled_2x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1325_nhd27oled_2x_gr_hw_spi = { u8g_dev_ssd1325_nhd27oled_2x_gr_fn, &u8g_dev_ssd1325_nhd27oled_2x_pb, u8g_com_null_fn };
