...
static const uint8_t u8g_dev_uc1610_dogxl160_init_seq[]  = {
  255, (0xd0 | ((0)&0x0f)),              
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xc0 | ((1)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
...
static const uint8_t u8g_dev_uc1610_dogxl160_data_start[]  = {
  255, (0xe0 | ((0)&0x0f)),            
  255, (0xd0 | ((1)&0x0f)),              
  0x010,		 
  0x000,		       
    ...
    case 21:
      {
        ...
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*2) );  
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*2+1) );  
        u8g_SetAddress(u8g, dev, 1);            
        for( i = 0; i < 160; i++ )
        {
    ...
    case 21:
      {
        u8g_pb_t *pb = (u8g_pb_t *)(dev->dev_mem);
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page) );  
        u8g_SetAddress(u8g, dev, 1);            
    ...
    case 21:
      {
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*4) );  
        u8g_SetAddress(u8g, dev, 1);            
        for( i = 0; i < 160; i++ )
        {
          u8g_WriteByte(u8g, dev, u8g_dev_1to2( ((uint8_t *)(pb->buf))[i] ) );          
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*4+1) );  
        u8g_SetAddress(u8g, dev, 1);            
        for( i = 0; i < 160; i++ )
        {
          u8g_WriteByte(u8g, dev, u8g_dev_1to2( ((uint8_t *)(pb->buf))[i] >> 4 ) );          
        ...
        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*4+2) );  
        u8g_SetAddress(u8g, dev, 1);            
        for( i = 0; i < 160; i++ )
        {
          u8g_WriteByte(u8g, dev, u8g_dev_1to2( ((uint8_t *)((uint8_t *)(pb->buf)+160))[i] ) );          
        }

        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*4+3) );  
        u8g_SetAddress(u8g, dev, 1);            
        for( i = 0; i < 160; i++ )
        {
          u8g_WriteByte(u8g, dev, u8g_dev_1to2( ((uint8_t *)((uint8_t *)(pb->buf)+160))[i] >> 4 ) );          
        }
    ...
    case 21:
      {
        ...
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*2) );  
        u8g_SetAddress(u8g, dev, 1);            
        if ( u8g_WriteSequence(u8g, dev, 160, pb->buf) == 0 )
          return 0;

        u8g_WriteEscSeqP(u8g, dev, u8g_dev_uc1610_dogxl160_data_start);    
        u8g_WriteByte(u8g, dev, 0x060 | (pb->p.page*2+1) );  
        u8g_SetAddress(u8g, dev, 1);            
        if ( u8g_WriteSequence(u8g, dev, 160, (uint8_t *)(pb->buf)+160) == 0 )
          return 0;
...
uint8_t u8g_dev_uc1610_dogxl160_bw_sw_spi_buf[160]  ; u8g_pb_t u8g_dev_uc1610_dogxl160_bw_sw_spi_pb = { {8, 104, 0, 0, 0}, 160, u8g_dev_uc1610_dogxl160_bw_sw_spi_buf}; u8g_dev_t u8g_dev_uc1610_dogxl160_bw_sw_spi = { u8g_dev_uc1610_dogxl160_bw_fn, &u8g_dev_uc1610_dogxl160_bw_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_uc1610_dogxl160_bw_hw_spi_buf[160]  ; u8g_pb_t u8g_dev_uc1610_dogxl160_bw_hw_spi_pb = { {8, 104, 0, 0, 0}, 160, u8g_dev_uc1610_dogxl160_bw_hw_spi_buf}; u8g_dev_t u8g_dev_uc1610_dogxl160_bw_hw_spi = { u8g_dev_uc1610_dogxl160_bw_fn, &u8g_dev_uc1610_dogxl160_bw_hw_spi_pb, u8g_com_null_fn };

uint8_t u8g_dev_uc1610_dogxl160_gr_sw_spi_buf[160]  ; u8g_pb_t u8g_dev_uc1610_dogxl160_gr_sw_spi_pb = { {4, 104, 0, 0, 0}, 160, u8g_dev_uc1610_dogxl160_gr_sw_spi_buf}; u8g_dev_t u8g_dev_uc1610_dogxl160_gr_sw_spi = { u8g_dev_uc1610_dogxl160_gr_fn, &u8g_dev_uc1610_dogxl160_gr_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_uc1610_dogxl160_gr_hw_spi_buf[160]  ; u8g_pb_t u8g_dev_uc1610_dogxl160_gr_hw_spi_pb = { {4, 104, 0, 0, 0}, 160, u8g_dev_uc1610_dogxl160_gr_hw_spi_buf}; u8g_dev_t u8g_dev_uc1610_dogxl160_gr_hw_spi = { u8g_dev_uc1610_dogxl160_gr_fn, &u8g_dev_uc1610_dogxl160_gr_hw_spi_pb, u8g_com_null_fn };

uint8_t u8g_dev_uc1610_dogxl160_2x_bw_buf[160*2]  ; 
u8g_pb_t u8g_dev_uc1610_dogxl160_2x_bw_pb = { {16, 104, 0, 0, 0},  160, u8g_dev_uc1610_dogxl160_2x_bw_buf}; 
u8g_dev_t u8g_dev_uc1610_dogxl160_2x_bw_sw_spi = { u8g_dev_uc1610_dogxl160_2x_bw_fn, &u8g_dev_uc1610_dogxl160_2x_bw_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_uc1610_dogxl160_2x_bw_hw_spi = { u8g_dev_uc1610_dogxl160_2x_bw_fn, &u8g_dev_uc1610_dogxl160_2x_bw_pb, u8g_com_null_fn };

uint8_t u8g_dev_uc1610_dogxl160_2x_gr_buf[160*2]  ; 
u8g_pb_t u8g_dev_uc1610_dogxl160_2x_gr_pb = { {8, 104, 0, 0, 0},  160, u8g_dev_uc1610_dogxl160_2x_gr_buf}; 
u8g_dev_t u8g_dev_uc1610_dogxl160_2x_gr_sw_spi = { u8g_dev_uc1610_dogxl160_2x_gr_fn, &u8g_dev_uc1610_dogxl160_2x_gr_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_uc1610_dogxl160_2x_gr_hw_spi = { u8g_dev_uc1610_dogxl160_2x_gr_fn, &u8g_dev_uc1610_dogxl160_2x_gr_pb, u8g_com_null_fn };
