...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
  {
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) |= ((0x1U << (17U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR) & ((0x1U << (17U)))); ((void)(tmpreg)); } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR &= ~((0x1U << (17U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0004)|((uint16_t)0x0008));
