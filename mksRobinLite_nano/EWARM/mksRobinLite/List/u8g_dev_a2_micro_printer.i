...
uint8_t u8g_dev_a2_micro_printer_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	u8g_WriteByte(u8g, dev, 27);       
	u8g_WriteByte(u8g, dev, 55 );       
	u8g_WriteByte(u8g, dev, 7);       
	u8g_WriteByte(u8g, dev, 160);       
	u8g_WriteByte(u8g, dev, 20);       
	
	u8g_WriteByte(u8g, dev, 18);       
	...
	u8g_WriteByte(u8g, dev, 55 );       
	u8g_WriteByte(u8g, dev, 7);       
	u8g_WriteByte(u8g, dev, 80);       
	u8g_WriteByte(u8g, dev, 2);       
...
uint8_t u8g_dev_a2_micro_printer_384x240_buf[240]  ; u8g_pb_t u8g_dev_a2_micro_printer_384x240_pb = { {8, 240, 0, 0, 0}, 240, u8g_dev_a2_micro_printer_384x240_buf}; u8g_dev_t u8g_dev_a2_micro_printer_384x240 = { u8g_dev_a2_micro_printer_fn, &u8g_dev_a2_micro_printer_384x240_pb, u8g_com_null_fn };
uint8_t u8g_dev_a2_micro_printer_192x360_ds_buf[192]  ; u8g_pb_t u8g_dev_a2_micro_printer_192x360_ds_pb = { {8, 240, 0, 0, 0}, 192, u8g_dev_a2_micro_printer_192x360_ds_buf}; u8g_dev_t u8g_dev_a2_micro_printer_192x360_ds = { u8g_dev_a2_micro_printer_double_fn, &u8g_dev_a2_micro_printer_192x360_ds_pb, u8g_com_null_fn };
uint8_t u8g_dev_a2_micro_printer_192x720_ds_buf[192]  ; u8g_pb_t u8g_dev_a2_micro_printer_192x720_ds_pb = { {8, 240, 0, 0, 0}, 192, u8g_dev_a2_micro_printer_192x720_ds_buf}; u8g_dev_t u8g_dev_a2_micro_printer_192x720_ds = { u8g_dev_a2_micro_printer_double_fn, &u8g_dev_a2_micro_printer_192x720_ds_pb, u8g_com_null_fn };

uint8_t u8g_dev_a2_micro_printer_192x120_ds_buf[192]  ; u8g_pb_t u8g_dev_a2_micro_printer_192x120_ds_pb = { {8, 120, 0, 0, 0}, 192, u8g_dev_a2_micro_printer_192x120_ds_buf}; u8g_dev_t u8g_dev_a2_micro_printer_192x120_ds = { u8g_dev_a2_micro_printer_double_fn, &u8g_dev_a2_micro_printer_192x120_ds_pb, u8g_com_null_fn };
