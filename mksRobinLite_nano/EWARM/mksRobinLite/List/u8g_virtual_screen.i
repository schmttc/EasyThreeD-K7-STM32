...
uint8_t u8g_dev_vs_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	if ( u8g_vs_current >= u8g_vs_cnt )   
	  return 0;
	return u8g_call_dev_fn(u8g_vs_list[u8g_vs_current].u8g, u8g_vs_list[u8g_vs_current].u8g->dev, 20, arg);	
      }
      return 0;
    case 70:
...
u8g_dev_t u8g_dev_vs = { u8g_dev_vs_fn, 0, 0 };
