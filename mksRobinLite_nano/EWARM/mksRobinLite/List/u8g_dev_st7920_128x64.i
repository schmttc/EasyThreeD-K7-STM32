    ...
    case 21:
      {
        ...
        {
          u8g_SetAddress(u8g, dev, 0);            
          u8g_WriteByte(u8g, dev, 0x03e );       

          if ( y < 32 )
          {
                  u8g_WriteByte(u8g, dev, 0x080 | y );       
                  u8g_WriteByte(u8g, dev, 0x080  );       
          }
          else
          {
                  u8g_WriteByte(u8g, dev, 0x080 | (y-32) );       
                  u8g_WriteByte(u8g, dev, 0x080 | 8);       
          }
          
          u8g_SetAddress(u8g, dev, 1);                   
          u8g_WriteSequence(u8g, dev, 128/8, ptr);
          ptr += 128/8;
          y++;
        }
...
uint8_t u8g_dev_st7920_128x64_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_st7920_128x64_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7920_128x64_sw_spi_buf}; u8g_dev_t u8g_dev_st7920_128x64_sw_spi = { u8g_dev_st7920_128x64_fn, &u8g_dev_st7920_128x64_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7920_128x64_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_st7920_128x64_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7920_128x64_hw_spi_buf}; u8g_dev_t u8g_dev_st7920_128x64_hw_spi = { u8g_dev_st7920_128x64_fn, &u8g_dev_st7920_128x64_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7920_128x64_8bit_buf[128]  ; u8g_pb_t u8g_dev_st7920_128x64_8bit_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7920_128x64_8bit_buf}; u8g_dev_t u8g_dev_st7920_128x64_8bit = { u8g_dev_st7920_128x64_fn, &u8g_dev_st7920_128x64_8bit_pb, u8g_com_null_fn };
uint8_t u8g_dev_st7920_128x64_custom_buf[128]  ; u8g_pb_t u8g_dev_st7920_128x64_custom_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_st7920_128x64_custom_buf}; u8g_dev_t u8g_dev_st7920_128x64_custom = { u8g_dev_st7920_128x64_fn, &u8g_dev_st7920_128x64_custom_pb, u8g_com_arduino_st7920_custom_fn };



uint8_t u8g_dev_st7920_128x64_4x_buf[(128*4)]  ; 
u8g_pb_t u8g_dev_st7920_128x64_4x_pb = { {32, 64, 0, 0, 0},  128, u8g_dev_st7920_128x64_4x_buf}; 
u8g_dev_t u8g_dev_st7920_128x64_4x_sw_spi = { u8g_dev_st7920_128x64_4x_fn, &u8g_dev_st7920_128x64_4x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7920_128x64_4x_hw_spi = { u8g_dev_st7920_128x64_4x_fn, &u8g_dev_st7920_128x64_4x_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_st7920_128x64_4x_8bit = { u8g_dev_st7920_128x64_4x_fn, &u8g_dev_st7920_128x64_4x_pb, u8g_com_null_fn };
