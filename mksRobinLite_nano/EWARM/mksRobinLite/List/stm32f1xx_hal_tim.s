...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\stm32f1xx_hal_tim.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  589   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.W    R1,??DataTable16  ;; 0x40012c00
        CMP      R0,R1
        BEQ.N    ??HAL_TIM_OC_Start_0
        LDR.W    R1,??DataTable17  ;; 0x40013400
        CMP      R0,R1
...
// 2084   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.N    R1,??DataTable16  ;; 0x40012c00
        CMP      R0,R1
        BEQ.N    ??HAL_TIM_OnePulse_Start_0
        LDR.N    R1,??DataTable17  ;; 0x40013400
        CMP      R0,R1
...
// 2156   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.W    R1,??DataTable22  ;; 0x40012c00
        CMP      R0,R1
...
// 2191   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        ...
        LDR.W    R1,??DataTable22_1  ;; 0x40013400
        CMP      R0,R1
...
// 2297   tmpccmr1 |= (sConfig->IC1Filter << 4) | (sConfig->IC2Filter << 12);
        LDR.W    R0,??DataTable22_2  ;; 0xfffffcfc
        ANDS     R7,R0,R7
        LDR      R0,[R6, #+8]
        ORRS     R7,R0,R7
        LDR      R0,[R6, #+24]
        ORR      R7,R7,R0, LSL #+8
        LDR.W    R0,??DataTable22_3  ;; 0xffff0303
        ANDS     R7,R0,R7
        LDR      R0,[R6, #+12]
        ORRS     R7,R0,R7
        LDR      R0,[R6, #+28]
...
// 3092   switch (Channel)
        CMP      R2,#+0
        BEQ.N    ??HAL_TIM_PWM_ConfigChannel_0
        CMP      R2,#+4
        ...
        B.N      ??HAL_TIM_PWM_ConfigChannel_4
// 3093   {
...
// 3202     switch (OutputChannel)
        ...
        CMP      R2,#+4
        BEQ.N    ??HAL_TIM_OnePulse_ConfigChannel_2
...
// 3796   switch (sClearInputConfig->ClearInputSource)
        ...
        B.N      ??HAL_TIM_ConfigOCrefClear_2
// 3797   {
...
// 3921   htim->Instance->SMCR = tmpsmcr;
        LDR.W    R0,??DataTable29_1  ;; 0xffff0088
        ANDS     R2,R0,R2
        STR      R2,[R3, #+8]
// 3922 
// 3923   switch (sClockSourceConfig->ClockSource)
        LDR      R0,[R1, #+0]
        CMP      R0,#+0
        BEQ.N    ??HAL_TIM_ConfigClockSource_0
        CMP      R0,#+16
...
// 4530   HAL_TIM_PeriodElapsedCallback(htim);
          CFI FunCall HAL_TIM_PeriodElapsedCallback
        B.W      HAL_TIM_PeriodElapsedCallback
// 4531 }
...
// 4559   if (IS_TIM_COUNTER_MODE_SELECT_INSTANCE(TIMx))
        LDR.N    R3,??DataTable29_2  ;; 0x40012c00
        CMP      R0,R3
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R2,??DataTable29_3  ;; 0x40013400
        CMP      R0,R2
        BEQ.N    ??TIM_Base_SetConfig_0
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R2,??DataTable29_4  ;; 0x40000400
        CMP      R0,R2
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R2,??DataTable29_5  ;; 0x40000800
        CMP      R0,R2
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R2,??DataTable29_6  ;; 0x40000c00
        CMP      R0,R2
...
// 4626   if(IS_TIM_CCXN_INSTANCE(TIMx, TIM_CHANNEL_1))
        LDR.N    R6,??DataTable29_2  ;; 0x40012c00
        CMP      R0,R6
...
// 4701   if(IS_TIM_CCXN_INSTANCE(TIMx, TIM_CHANNEL_2))
        LDR.N    R2,??DataTable29_2  ;; 0x40012c00
        CMP      R0,R2
        BEQ.N    ??TIM_OC2_SetConfig_0
        LDR.N    R6,??DataTable29_3  ;; 0x40013400
        CMP      R0,R6
...
// 4851   if(IS_TIM_BREAK_INSTANCE(TIMx))
        LDR.N    R5,??DataTable29_2  ;; 0x40012c00
        CMP      R0,R5
        BEQ.N    ??TIM_OC4_SetConfig_0
        LDR.N    R5,??DataTable29_3  ;; 0x40013400
        CMP      R0,R5
...
// 5038   if(IS_TIM_CC2_INSTANCE(TIMx) != RESET)
        ...
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable29_4  ;; 0x40000400
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable29_5  ;; 0x40000800
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable29_6  ;; 0x40000c00
        CMP      R0,R6
