...
//    Locale       =  C
//    List file    =  F:\nano\EWARM\mksRobinLite\List\u8g_dev_st7920_192x32.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC u8g_dev_st7920_192x32_4x_8bit
        PUBLIC u8g_dev_st7920_192x32_4x_buf
        PUBLIC u8g_dev_st7920_192x32_4x_fn
        PUBLIC u8g_dev_st7920_192x32_4x_hw_spi
        PUBLIC u8g_dev_st7920_192x32_4x_pb
        PUBLIC u8g_dev_st7920_192x32_4x_sw_spi
        PUBLIC u8g_dev_st7920_192x32_8bit
        PUBLIC u8g_dev_st7920_192x32_8bit_buf
        PUBLIC u8g_dev_st7920_192x32_8bit_pb
        PUBLIC u8g_dev_st7920_192x32_fn
        PUBLIC u8g_dev_st7920_192x32_hw_spi
        PUBLIC u8g_dev_st7920_192x32_hw_spi_buf
        PUBLIC u8g_dev_st7920_192x32_hw_spi_pb
        PUBLIC u8g_dev_st7920_192x32_sw_spi
        PUBLIC u8g_dev_st7920_192x32_sw_spi_buf
        PUBLIC u8g_dev_st7920_192x32_sw_spi_pb
...
//   62 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_st7920_192x32_fn
        THUMB
...
//   65   switch(msg)
        MOV      R0,R7
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_st7920_192x32_fn_0
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_st7920_192x32_fn_1
        B.N      ??u8g_dev_st7920_192x32_fn_2
//   66   {
//   67     case U8G_DEV_MSG_INIT:
//   68       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_400NS);
??u8g_dev_st7920_192x32_fn_0:
        MOVS     R2,#+3
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
//   69       u8g_WriteEscSeqP(u8g, dev, u8g_dev_st7920_192x32_init_seq);
        ADR.N    R2,u8g_dev_st7920_192x32_init_seq
        MOV      R1,R5
        MOV      R0,R4
...
//   83         for( i = 0; i < 8; i ++ )
        MOV      R10,#+0
        B.N      ??u8g_dev_st7920_192x32_fn_3
//   84         {
//   85           u8g_SetAddress(u8g, dev, 0);           /* cmd mode */
??u8g_dev_st7920_192x32_fn_4:
        MOVS     R2,#+0
        MOV      R1,R5
        MOV      R0,R4
          CFI FunCall u8g_SetAddress
...
//   93         }
        ADD      R10,R10,#+1
??u8g_dev_st7920_192x32_fn_3:
        MOV      R0,R10
        UXTB     R0,R0
        CMP      R0,#+8
        BLT.N    ??u8g_dev_st7920_192x32_fn_4
...
//  100 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function u8g_dev_st7920_192x32_4x_fn
        THUMB
...
//  103   switch(msg)
        MOV      R0,R7
        CMP      R0,#+10
        BEQ.N    ??u8g_dev_st7920_192x32_4x_fn_0
        CMP      R0,#+21
        BEQ.N    ??u8g_dev_st7920_192x32_4x_fn_1
        B.N      ??u8g_dev_st7920_192x32_4x_fn_2
//  104   {
//  105     case U8G_DEV_MSG_INIT:
//  106       u8g_InitCom(u8g, dev, U8G_SPI_CLK_CYCLE_400NS);
??u8g_dev_st7920_192x32_4x_fn_0:
        MOVS     R2,#+3
        MOV      R0,R4
          CFI FunCall u8g_InitCom
        BL       u8g_InitCom
...
//  121         for( i = 0; i < 32; i ++ )
        MOV      R10,#+0
        B.N      ??u8g_dev_st7920_192x32_4x_fn_3
//  122         {
//  123           u8g_SetAddress(u8g, dev, 0);           /* cmd mode */
??u8g_dev_st7920_192x32_4x_fn_4:
        MOVS     R2,#+0
        MOV      R1,R5
        MOV      R0,R4
          CFI FunCall u8g_SetAddress
...
//  131         }
        ADD      R10,R10,#+1
??u8g_dev_st7920_192x32_4x_fn_3:
        MOV      R0,R10
        UXTB     R0,R0
        CMP      R0,#+32
        BLT.N    ??u8g_dev_st7920_192x32_4x_fn_4
...
u8g_dev_st7920_192x32_sw_spi_pb:
        DC8 8, 32, 0, 0, 0, 192, 0, 0
        DC32 u8g_dev_st7920_192x32_sw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_st7920_192x32_sw_spi
u8g_dev_st7920_192x32_sw_spi:
        DC32 u8g_dev_st7920_192x32_fn, u8g_dev_st7920_192x32_sw_spi_pb
...
u8g_dev_st7920_192x32_hw_spi_pb:
        DC8 8, 32, 0, 0, 0, 192, 0, 0
        DC32 u8g_dev_st7920_192x32_hw_spi_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_st7920_192x32_hw_spi
u8g_dev_st7920_192x32_hw_spi:
        DC32 u8g_dev_st7920_192x32_fn, u8g_dev_st7920_192x32_hw_spi_pb
        DC32 u8g_com_null_fn
...
u8g_dev_st7920_192x32_8bit_pb:
        DC8 8, 32, 0, 0, 0, 192, 0, 0
        DC32 u8g_dev_st7920_192x32_8bit_buf

        SECTION `.data`:DATA:REORDER:NOROOT(2)
        DATA
// __absolute u8g_dev_t u8g_dev_st7920_192x32_8bit
u8g_dev_st7920_192x32_8bit:
        DC32 u8g_dev_st7920_192x32_fn, u8g_dev_st7920_192x32_8bit_pb
        DC32 u8g_com_null_fn
//  143 
//  144 
...
u8g_dev_st7920_192x32_4x_pb:
        DC8 32, 32, 0, 0, 0, 192, 0, 0
        DC32 u8g_dev_st7920_192x32_4x_buf
...
u8g_dev_st7920_192x32_4x_sw_spi:
        DC32 u8g_dev_st7920_192x32_4x_fn, u8g_dev_st7920_192x32_4x_pb
        DC32 u8g_com_null_fn
