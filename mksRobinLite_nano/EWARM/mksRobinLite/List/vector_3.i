...
float vector_3::get_length() { return sqrt(pow(x,2) + pow(y,2) + pow(z,2)); }
...
void vector_3::debug(const char * const title) {
  ...
  {serialprintPGM((" x: "));};
  {if(!from_wifi_flag){customizedSerial . print(x,6);}else{serial2 . print(x,6);}};
  {serialprintPGM((" y: "));};
  {if(!from_wifi_flag){customizedSerial . print(y,6);}else{serial2 . print(y,6);}};
  {serialprintPGM((" z: "));};
  {if(!from_wifi_flag){customizedSerial . print(z,6);}else{serial2 . print(z,6);}};
...
void matrix_3x3::debug(const char * const title) {
  ...
  for (uint8_t i = 0; i < 3; i++) {
    for (uint8_t j = 0; j < 3; j++) {
      if (matrix[count] >= 0.0) {if(!from_wifi_flag){customizedSerial . write('+');}else{serial2 . print('+');}};
      {if(!from_wifi_flag){customizedSerial . print(matrix[count],6);}else{serial2 . print(matrix[count],6);}};
