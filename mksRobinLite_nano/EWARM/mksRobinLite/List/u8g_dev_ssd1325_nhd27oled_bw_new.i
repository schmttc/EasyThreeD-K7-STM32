...
static const uint8_t u8g_dev_ssd1325_nhd_27_12864_init_seq[]  = {
  255, ((10) & 0x7f),               
  255, (0xd0 | ((0)&0x0f)),                  
  255, (0xe0 | ((0)&0x0f)),                
  255, (0xc0 | ((1)&0x0f)),                
...
static const uint8_t u8g_dev_ssd1325_prepare_row_seq[]  = {
  255, (0xe0 | ((0)&0x0f)),                
  255, (0xd0 | ((1)&0x0f)),                 
  0x015,        
  0x000,        
...
static uint8_t u8g_dev_ssd1325_nhd27oled_bw_fn(u8g_t *u8g, u8g_dev_t *dev, uint8_t msg, void *arg)
{
  switch(msg)
  {
	...
	{
	  u8g_dev_ssd1325_prepare_row(u8g, dev, i);		 
...
uint8_t u8g_dev_ssd1325_nhd27oled_bw_sw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1325_nhd27oled_bw_sw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1325_nhd27oled_bw_sw_spi_buf}; u8g_dev_t u8g_dev_ssd1325_nhd27oled_bw_sw_spi = { u8g_dev_ssd1325_nhd27oled_bw_fn, &u8g_dev_ssd1325_nhd27oled_bw_sw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1325_nhd27oled_bw_hw_spi_buf[128]  ; u8g_pb_t u8g_dev_ssd1325_nhd27oled_bw_hw_spi_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1325_nhd27oled_bw_hw_spi_buf}; u8g_dev_t u8g_dev_ssd1325_nhd27oled_bw_hw_spi = { u8g_dev_ssd1325_nhd27oled_bw_fn, &u8g_dev_ssd1325_nhd27oled_bw_hw_spi_pb, u8g_com_null_fn };
uint8_t u8g_dev_ssd1325_nhd27oled_bw_parallel_buf[128]  ; u8g_pb_t u8g_dev_ssd1325_nhd27oled_bw_parallel_pb = { {8, 64, 0, 0, 0}, 128, u8g_dev_ssd1325_nhd27oled_bw_parallel_buf}; u8g_dev_t u8g_dev_ssd1325_nhd27oled_bw_parallel = { u8g_dev_ssd1325_nhd27oled_bw_fn, &u8g_dev_ssd1325_nhd27oled_bw_parallel_pb, u8g_com_null_fn };

uint8_t u8g_dev_ssd1325_nhd27oled_2x_bw_buf[128*2]  ; 
u8g_pb_t u8g_dev_ssd1325_nhd27oled_2x_bw_pb = { {16, 64, 0, 0, 0},  128, u8g_dev_ssd1325_nhd27oled_2x_bw_buf}; 
u8g_dev_t u8g_dev_ssd1325_nhd27oled_2x_bw_sw_spi = { u8g_dev_ssd1325_nhd27oled_2x_bw_fn, &u8g_dev_ssd1325_nhd27oled_2x_bw_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1325_nhd27oled_2x_bw_hw_spi = { u8g_dev_ssd1325_nhd27oled_2x_bw_fn, &u8g_dev_ssd1325_nhd27oled_2x_bw_pb, u8g_com_null_fn };
u8g_dev_t u8g_dev_ssd1325_nhd27oled_2x_bw_parallel = { u8g_dev_ssd1325_nhd27oled_2x_bw_fn, &u8g_dev_ssd1325_nhd27oled_2x_bw_pb, u8g_com_null_fn };
