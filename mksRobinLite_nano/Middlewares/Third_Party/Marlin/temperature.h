...
class Temperature {
  ...
  public:
    ...
    //static int16_t current_temperature_raw[HOTENDS],  /*--mks--*/
    ...
    //#if ENABLED(PIDTEMP) || ENABLED(PIDTEMPBED)	/*--mks cfg--*/
    #if 1
      //#define PID_dT ((OVERSAMPLENR * float(ACTUAL_ADC_SAMPLES)) / (F_CPU / 64.0 / 256.0))	/*--mks--*/
...
//    static int16_t degBed() { return current_temperature_bed; }
    static float degBed() { return current_temperature_bed; }
      ...
      static float rawHotendTemp(uint8_t e) { /*--mks--*/
        #if HOTENDS == 1
          UNUSED(e);
        #endif
